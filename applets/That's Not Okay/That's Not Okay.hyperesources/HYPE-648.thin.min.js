...
jd=".HYPE_scene ",kd="/",ld="0",md="0.0",nd="0123456789ABCDEF",od="1",pd="1.0",qd="100%",rd=": ",Vd="</div>",Wd="</style>",Xd="<div style='overflow:auto;-webkit-overflow-scrolling:touch;width:100%;height:100%;'>",Yd="<iframe frameBorder='0'style='width:100%;height:100%;border:none' allowfullscreen='true'></iframe>",Zd='<style id="" type="text/css">',$d="=",ae="?",be="@1x",ce="@2x",de="APPLY ERR ",ee="Action",fe="Android",ge="BD",he="BODY",ie="BackCompat",je="ERROR: timeline named '",ke="Error in ",
...
(function(){q.HYPE_648T=function(ka,aa,K,le,Xf,Yf,Aa,t,qb,kk,cc,sd,tk,Zf,me,td,lk,mk,uk,Ic){function $f(a,b,c){Jc!=h&&(a={element:a,triggerOnce:j,elementOffset:0},a[c]=function(){b()},c=new Jc.hypeS(a),ud[y](c))}function X(a,b){return function(c){for(var e=0;e<b[L];e++){var d=b[e],f=d.p;if(1==f)Kc(nk(d.e,d.f),d.g,d.d);else if(3==f)d.b!=h&&(f=d.z!=ca?d.z:j,db(d.b,a!=h?a.id:h,f));else if(7==f)d.b!=h&&eb(d.b,d.r);else if(8==f)d.b!=h&&(f=d.z!=ca?d.z:j,Lc(d.b,f,g,d.J!=ca?d.J:j));else if(9==f)d.b!=h&&d.i!=
h&&fb(d.i,d.b,j,g);else if(4==f){var k;d.h!=h?k=Yf[kk[d.h]]:d.hc!=h&&(k=d.hc);try{k&&k(R.API,a,c)}catch(p){Mc(ke+E+rd+p)}}else if(5==f)f=ag(d.j),f!=h&&((d=(d=d.k==g)||1==c[Ra]||c.metaKey==g)?9>w.ga||w.ga!=h&&w.sb||w.Fa!=h?q.open(f,Nf):(9==w.ga||15>w.opera)&&!(c instanceof MouseEvent)?q.open(f,Nf):(d=x[Ob](Of),d[Nb](zi,f),d[Nb](Mj,Nf),x[Sa][Za](d),f=x.createEvent(yf),f.initMouseEvent(Xh,c.bubbles,c.cancelable,c.view,c.detail,c.screenX,c.screenY,c[cb],c[ib],c[kb],c.altKey,c.shiftKey,c.metaKey,c[Ra],
x[Sa][Q]),d.dispatchEvent(f),x[Sa][Db](d)):q.top.location=f);else if(6==f){var m=d.l,r=d.m,d=d.n,f=Vi;m!=h&&(f+=escape(m));if(r!=h||d!=h)f+=ae,m=[],r!=h&&m[y](Gj+fa(r)),d!=h&&m[y](Bh+fa(d)),f+=m.join(yc);f!=Vi&&(q.top.location=f)}else if(12==f)f=d.o,d=d.q,d!=g&&(d=j),f!=h&&playAudioResourceGroupOid(f,d);else if(13==f)f=d.o,f!=h&&pauseAudioResourceGroupOid(f);else if(14==f)f=d.B,f!=h&&bg(f);else if(15==f){var E=d.s;arguments=d.t;f=Y+E+Cc+arguments.join(Fc)+Dc;try{eval(f)}catch(l){Mc(ke+E+rd+l)}}}}}
function nk(a,b){var c=-1;if(b==h||0==b)a:{for(c=0;c<Aa[L];c++)if(Aa[c].o==a)break a;c=-1}else 1==b&&Ha+1<Aa[L]?c=Ha+1:2==b?c=Ha-1:3==b?c=0:4==b&&(c=Aa[L]-1);return c}function vd(a,b){return function(c){ne(c,b,J[a.id])}}function oe(a,b){return function(c){cg(c,b,J[a.id])}}function dc(){}function dg(a){var b=l(a,Yg,8),c=l(a,Xg,0);w.kb==h&&(1==1-c&&a[B].removeProperty!=h?a[B].removeProperty(R.na+Ch):a[B][R.na+Ch]=yh+z(b)+Sb+(1-c)+Gc)}function pe(a){var b=l(a,Kf);if(b!=h){var c=Y;b==od?c=ag(l(a,Lf)):
...
k||(c+=ji+(z(e)+Rb+z(d)+Rb+z(k)+Rb+f)+Ec));c==Y&&(c=fj);b==g?(a[B][R.na+vh]=c,a[B][vh]=c,c=a[B][Ma],la(a[B],fj),la(a[B],a[B][Ma]+(Y+a[ab]).substring(0,0)),la(a[B],c)):(a[B][R.na+qi]=c,a[B].filter=c)}}function fc(a){qe(a,j)}function gc(a){qe(a,g)}function wd(a){var b=l(a,hh),c=l(a,ih),e=l(a,gh),d=l(a,$g);b==h||(c==h||e==h||d==h)||(a[B].textShadow=(0==b&&0==c&&0==d)==g?fj:Y+z(b)+Rb+z(c)+Rb+z(d)+Rb+e)}function Nc(a){if(1==l(a,vi,0))qe(a);else{var b=l(a,Ff),c=l(a,If),e=l(a,Ef),d=l(a,Df),f=l(a,vi,0);if(!(b==
h||c==h||e==h||d==h))for(var k=[R.na+Dh,zf,Eh,Dh],p=0==b&&0==c&&0==d,b=(2==f?Ki:Y)+z(b)+Rb+z(c)+Rb+z(d)+Rb+e,c=0;c<k[L];c++)p==g?a[B].removeProperty(k[c]):a[B][k[c]]=b}}function hc(a){var b=re(a),c=b==j?h:l(a,bf),e=b==j?h:l(a,af),d=l(a,rh,0),f=l(a,sh,0),k=l(a,Zg,0),p=l(a,pi,0),m=l(a,Oh,1)*l(a,gf,1),r=l(a,Ph,1)*l(a,hf,1),E=l(a,ui,0),u=l(a,Zj,0),s=l(a,ff),I=0!=l(a,ph,0),A=l(a,di)==lj,ok=l(a,Ij,0.5),N=l(a,Jj,0.5),b=Y,O=l(a,ci)==Hf;if(O==g){var M=na(xd(J[a.id])),U=M.clientWidth;0==U&&(U=l(M,Gh,0));var G=
M.clientHeight;0==G&&(G=l(M,ai,0));var M=l(a,Gh,0),C=l(a,ai,0);0!=M&&0!=U&&(m*=U/M);0!=C&&0!=G&&(r*=G/C)}if(s==h){s=j;U=gb(a);U=t[U].v;for(G=J[a.id];G!=h&&U[G]!=h;)if(G=U[G].bF,G!=h&&U[G]!=h&&(U[G].cQ!=h||U[G].cR!=h||ic==g&&0!=(U[G].bS&256))){s=g;break}hb(a,ff,s)}s=td==g&&-1==a[zb][nb](Ze)&&1==m&&1==r&&s==j&&A==j&&O==j&&!(I==g&&50<=w.Na);if(10<=w.ga&&0==p&&(1!=m||1!=r)&&0==l(a,Af,0)&&0==l(a,Bf,0)&&0==l(a,Cf,0)&&0==l(a,wf,0))p=1E-5;c!=h&&(b+=$b+z(c,2)+Ec);e!=h&&(b+=ac+z(e,2)+Ec);0!=d&&(b+=bc+z(d)+
...
var k=S[f][Cb];T[J[k.id]]=h;var p=x[Ob](d.k);qa(p,d.cP?Ve+d.cP:Ue);p.id=k.id;p[B].pointerEvents=eh;for(p[B][nj]=eh;0<k.childNodes[L];)p[Za](k.childNodes[0]);k[Q]&&(k[Q][Za](p),k[Q][Db](k));k=p;p=S[f].element=k;if(p[Q]&&p[Q][zb]==Xe){var p=p[Q],m=p[B];if(d.bR!=h||d.aY!=h){var r=t[F].p;m[fd]=r;m.MozPerspective=r;m.perspective=r}else m[fd]=Y,m.MozPerspective=Y,m.perspective=Y}b[Za](p);De(d,k,k.id,j);d=Gd(k);for(k=0;k<d[L];k++){m=d[k];p=a[J[m.id]];for(r=0;2>r;r++)for(var E=0;E<Rc[L];E++){var u=Rc[E];
if(p[H](u)!=j){var s=0==r?j:g;if(u==Uf||u==Vf)s=0==r?g:j;s!=j&&ba(m,u,p[u])}}}f=S[f].ib;for(k=0;k<f[L];k++)Oa[y](f[k])}}f=x[lb](Ye);for(e in S)if(S[H](e)!=j){d=j;for(k=0;k<c[L];k++)if(c[k]===e){d=g;break}d==j&&(k=S[e][Cb],k[Q][zb]==Xe&&(k=k[Q]),f[Za](k))}C[Ya](dh);C[Ya](ch);b[Ya](dh);db(Mi,h,j);e=Gd(pa());for(k=0;k<e[L];k++)if(d=e[k],yg(d)!=j){if(f=a[J[d.id]].cL){c=S[f];if(c.ob)continue;c.ob=g}c={type:rf};Wa(c,d);(f=l(d,Mh))&&X(d,f.a)(c)}a={type:nf};Wa(a,h)!==j&&(e=t[Dd(J[b.id])].A,e!=h&&(e=e.a,X(pa(),
e)(a)));a=gb(b);b=zg(b);for(e=0;e<b[L];e++)if(c=b[e],k=x[lb](c),c=t[a].v[J[c]],c!=h)for(f=0;f<Hd[L];f++)d=Hd[f],c[H](d)!=j&&ba(k,d,c[d])}function Ag(a,b){var c=gb(a),e=zg(a);yd=g;for(var d=0;d<e[L];d++){var f=e[d],k=x[lb](f),p=t[c].v[J[f]];p!=h&&De(p,k,f,b)}ng()}function zg(a){a=Gd(a);for(var b=[],c=0;c<a[L];c++)b[y](a[c].id);return b}function De(a,b,c,e){var d=[jh,th,ci,Ij,Jj,fh,Of,Gh,ai,Li,vi,bi],f=J[c];T[f]==h&&(T[f]={});var f=gb(b),k=t[f].U[J[c]];if(k){var p=function(a){var b=k.V[a];if(b!=h)return b;
...
p(b),j,j)},currentTimeInTimelineNamed:function(a){return pc(p(a),g)},durationForTimelineNamed:function(a){a=$(p(a));return ia(a)},currentDirectionForTimelineNamed:function(a){return $(p(a)).$?1:0},isPlayingTimelineNamed:function(a){return $(p(a)).da}}}mk==j&&a.bE==h&&hb(b,ef,od);for(c=0;c<d[L];c++)f=d[c],ba(b,f,a[f]);Rc[y](Ih,Jh,Kh,Lh,Mh,Hh);for(var m in a)if(a[H](m)!=j){d=g;for(c=0;c<Hd[L];c++)if(Hd[c]==m){d=j;break}if(d!=j){if(e==g)for(c=0;c<Rc[L];c++)if(Rc[c]==m){d=j;break}d!=j&&ba(b,m,a[m])}}}
function pk(){Sc[Da](0,1)}function Id(a){Sc[y](Jd(a));q[wb](pk,2500)}function Kd(a){for(var b=0;b<Sc[L];b++){var c=Jd(a);25>n.abs(c.x-Sc[b].x)&&25>n.abs(c.y-Sc[b].y)&&(a.stopPropagation(),a[Ea]())}}function Bg(a){var b=[],c=t[F].U,e;for(e in c)c[H](e)!=j&&c[e].n==a&&b[y](sb[e]);return b}function bg(a){var b={type:vf,customBehaviorName:a},c=Ld[a];if(c!=h)for(var e=0;e<c[L];e++)c[e](b);for(var d in S)S[H](d)!=j&&(c=S[d].Xa[a],c!=h&&c(b));Wa(b,h)}function Cg(a,b,c){c?S[c].Xa[a]=b:(c=Ld[a],c==h&&(c=[],
Ld[a]=c),c[y](b))}function Ee(a,b,c,e){function d(a){a=a?a:q[bb];(32==a.keyCode||13==a.keyCode)&&f(a)}function f(a){a=a?a:q[bb];if(a[xa]==aj){for(var d=j,f=0;f<Tc[L];f++)if(Tc[f]==c){d=g;break}if(d==g)return;Tc[y](c)}else if(a[xa]==$i){d=gb(b);if(t[d].v[J[b.id]]==h)return;a||(a=q[bb]);for(d=x.elementFromPoint(a[cb],a[ib]);d!=h&&d!=this&&d.nodeName!=he;)d=d[Q];if(d==this)return;Tc=[]}else if(-1!=[Yi,bj,oj][nb](a[xa])){if(a[kb]==g||0!=a[Ra])return}else a[xa]==Vj?0<a[xb][L]&&Id(a[xb][0]):a[xa]==Tj&&
0<a[pb][L]&&Id(a[pb][0]);if(e==g&&(a[xa]==Xi||a[xa]==bj||a[xa]==Tj)){if(0<Md)return;Nd=g}c(a)}if(a==Xh||a==bj)a=ga.pointerEnabled||q.PointerEvent?oj:ga.msPointerEnabled?xf:bj;ua(a,f,b,g);a==Xh?ua(Oi,d,b,g):a==Yi?ua(Ni,d,b,g):a==bj&&ua(Pi,d,b,g)}function va(a,b,c,e){Ee(a,b,c,e);a==aj?Ee($i,b,jk(),e):a==$i&&Ee(aj,b,jk(),e)}function Ib(a,b,c){c={xa:h,ra:mi,Aa:0,va:h,Ga:0,jb:0,Ra:0,eb:0,Ya:0,Za:0,Va:h,Ua:h,ia:h,fa:j,Oa:j,options:b,Wa:c,za:a};ua(Vj,Dg(c),a,g);if(b.ca==ii||b.ca==Hj){var e=a==x?C:a;e[B].msTouchAction=
fj;e[B].touchAction=fj}b.ca!=Lj&&ua(Yi,Dg(c),a,g)}function Eg(a,b){for(var c={wa:1,lb:g,ca:ii},e=b.a,d=g,f=0;f<e[L];f++){var k=e[f],p=k.p;0!=p&&(d=j);10==p&&k.b!=h?(c.la==h&&(c.la=[]),c.la[y]({b:k.b,c:k.c,A:k.A,y:k.y,K:100/k.K})):11==p&&(c.ua=a)}d==j&&Ib(a,c,X(a,e))}function Dg(a){return function(b){a.La=j;a.Ma=j;for(var c=b.target||b.srcElement,e=pa();c!=h&&c!=e;){if(c[B]&&(c[B].overflow==Aj||c[B].overflow==eh)){a.La=0<c.scrollWidth-c.clientWidth;a.Ma=0<c.scrollHeight-c.clientHeight;break}c=c[Q]}c=
a.La==j&&a.Ma==j;a.fa=b[xa]==Vj;if(a.fa)0<b[xb][L]&&(a[Ab].ca==Lj&&c==g)&&Id(b[xb][0]),a.Aa=b[xb][L];else{if(b[kb]==g||0!=b[Ra])return;b[Ea]&&c==g&&b[Ea]()}if(a.fa==j||1===a.Aa){a.ra=Ej;a.xa=h;c=[];for(e=0;5>=e;e++)c[y]({start:{x:0,y:0},end:{x:0,y:0},lastPosition:{x:0,y:0}});a.va=c;a.ya=ca;a.Oa=j;var c=a.fa?b[xb][0]:b,d;d=function(b){Fe(a);a.ra=Vh;Od(b,a)};a.ia=d;b=a.fa?a.za:x;a.fa?ua(Sj,a.ia,b,j):q.self!=q.top&&(e=function(a){(a.relatedTarget===x.documentElement||a.toElement===h)&&d(a)},a.ia=e,ua($i,
e,b,j));c=Jd(c);e=a.va[0];e[Bb].x=c.x;e.end.x=c.x;e[sa].x=c.x;e[Bb].y=c.y;e.end.y=c.y;e[sa].y=c.y;Fg(a,c);a.Va=function(b){if(!(a.ra===mi||a.ra===Vh))if(Nd==g)a.ia(b);else{var c=a[Ab];if(a.Ha==j==g&&(Md++,a.Ha=g,c.ca==ii)){Uc==g&&a.ia(b);a.za!=x&&(Uc=g);if(c.la!=h)for(var e=0;e<c.la[L];e++){var d=c.la[e].b,r=$(d);eb(d,h);mc(r,j);a.jb=pc(r.aa,j);for(var t=r.ma,u=0;u<t[L];u++){var s=t[u].o,I=t[u].i;Ja[s]===ca&&(Ja[s]={});Ja[s][I]=r.aa}}c.ua!=h&&(e=J[c.ua.id],a.Ya=l(c.ua,bf,T[e].a),a.Za=l(c.ua,af,T[e].b),
Ia[e]!=ca&&(Ia[e].a=h,Ia[e].b=h,rg(h)),Ja[e]===ca&&(Ja[e]={}),Ja[e].a=li,Ja[e].b=li);Od(b,a)}t=Jd(a.fa?b[xb][0]:b);s=a.va[0];s[sa].x=s.end.x;s[sa].y=s.end.y;a.Ra=a.eb;s.end.x=a.fa?b[xb][0].pageX:t.x;s.end.y=a.fa?b[xb][0].pageY:t.y;u=Na();a.eb=u;u-=a.Ga;a.xa=Gg(s[Bb],s.end,u);a.fa&&(a.Aa=b[xb][L]);a.ra=cj;if(c.ca==ii){u=a.La==j&&a.Ma==j;if(c.la!=h)for(e=0;e<c.la[L];e++){var A=c.la[e];if(0==A.c&&a.La==g||1==A.c&&a.Ma==g){a.ia(b);return}}b[Ea]&&u==g&&b[Ea]();var u=I=0,w=1,N=1;if(a.za!=h)for(var O=xd(J[a.za.id]);O!=
h&&O!=aa;)e=na(O),I+=l(e,Of,0),u+=l(e,fh,0),w*=l(e,Oh,1),w*=l(e,gf,1),N*=l(e,Ph,1),N*=l(e,hf,1),O=xd(O);if(c.la!=h)for(var M=c.la,e=0;e<M[L];e++)if(A=M[e],d=A.b,r=$(d)){var r=ia(r),U=Hg(A),G;U==wj?G=(s.end.x-s[Bb].x)/w:U==Ri?G=(s[Bb].x-s.end.x)/w:U==$j?G=(s[Bb].y-s.end.y)/N:U==hi&&(G=(s.end.y-s[Bb].y)/N);A=G/A.K;A+=a.jb;A=n.min(r,A);A=n.max(0,A);fb(A,d,j,g)}else a.ia(b);c.ua!=h&&(e=J[c.ua.id],G=a.Ya+(s.end.x-s[Bb].x)/w,s=a.Za+(s.end.y-s[Bb].y)/N,ic==j&&(O=hg(O),N=ue(e),G=n.max(G,-N/2-I),G=n.min(G,
O[La]-N/2-I),I=ve(e),s=n.max(s,-I/2-u),s=n.min(s,O[mb]-I/2-u)),ba(c.ua,Of,G,fh,s));Od(b,a)}else c.ca==Hj?1<a.Aa?a.ia(b):(b[Ea]&&a.xa==c[Eb]&&b[Ea](),G=c[Eb]==wj||c[Eb]==Ri?s.end.x:s.end.y,O=j,O=c[Eb]==wj||c[Eb]==hi?20<a.ya-G:20<G-a.ya,c=a.xa===c[Eb]||100>u,(O||c==j||Uc==g)&&a.ia(b)):c.ca==Lj&&5<Ge(s[Bb],s.end)&&a.ia(b);Fg(a,t)}};ua(a.fa?Uj:Zi,a.Va,b,j);a.Ua=function(b){if(!(a.ra===mi||a.ra===Vh)&&!(b[xb]&&0<b[xb][L]))if(Nd==g&&0<Md)a.ia(b);else{var c=a[Ab];b[xa]==Tj&&0<b[pb][L]&&c[xa]==Lj&&Id(b[pb][0]);
...
N=0;w<d.ma[L];w++){var G=d.ma[w];if(2==G.p){for(var v=G.s.a,z=j,J=0;J<v[L];J++){var D=v[J];if(7==D.p&&D.b!=h&&D.b==e){z=g;break}}z==g&&(G=G.t,v=n.abs(G-s),v<C&&(C=v,N=G))}}A-s<C&&(N=A,C=A-s);0!=C&&(O=g,M=N<s,U=n.abs(N-s)/0.2)}mc(d,M);Pc(d,U);O==g&&d.ha!=A?Lc(e,M,j,j):fb(M?A-d.ha:d.ha,e,g,g)}}}Od(b,a)}else c.ca==Hj?(e=a.xa===c[Eb],l=Ge(l[Bb],l.end),t&&(u&&e)&&l>c.Ea?(b={type:qf+c[Eb][Lb](0).toUpperCase()+c[Eb][Qa](1)+ee},a.Wa(b)):a.ia(b)):c.ca==Lj?1500>d&&a.Wa(b):a.ia(b);Fe(a)}};ua(a.fa?Tj:bj,a.Ua,
b,j);b.setCapture&&b.setCapture();a.Ga=Na();a.Ra=a.Ga;Uc=Nd=a.Ha=j}}}function Fe(a){if(a.Oa!=g){a.Oa=g;Ja={};var b=a.fa?a.za:x;b.releaseCapture&&b.releaseCapture();Vc(a.fa?Uj:Zi,a.Va,b);Vc(a.fa?Tj:bj,a.Ua,b);a.fa?Vc(Sj,a.ia,b):Vc($i,a.ia,b);a[Ab].ca==ii&&(Uc=j);a.Ha==g&&Md--}}function Od(a,b){b[Ab].lb==g&&(a.hypeGesturePhase=b.ra,a.hypeGestureXPosition=b.va[0].end.x,a.hypeGestureYPosition=b.va[0].end.y,b.Wa(a))}function Vc(a,b,c){c[Mb]?c[Mb](a,b,j):c[za]&&c[za](hj+a,b)}function ua(a,b,c,e){var d=
{eventType:a,handler:b,element:c};e&&Pd[y](d);c[Ca]?c[Ca](a,b,w.Ta?{passive:j}:j):c[jb]&&c[jb](hj+a,b);eg(c)}function Jd(a){var b={};if(a.pageX||a.pageY)b.x=a.pageX,b.y=a.pageY;else if(a[cb]||a[ib])b.x=a[cb]+x[Sa].scrollLeft+x.documentElement.scrollLeft,b.y=a[ib]+x[Sa].scrollTop+x.documentElement.scrollTop;return b}function Hg(a){var b;0==a.c?0==a.A?b=wj:1==a.A&&(b=Ri):1==a.c&&(0==a.A?b=$j:1==a.A&&(b=hi));return b}function Fg(a,b){var c=a[Ab],e=c[Eb]==wj||c[Eb]==Ri?b.x:b.y;a.ya=a.ya==ca?e:c[Eb]==
wj||c[Eb]==hi?n.max(a.ya,e):n.min(a.ya,e)}function Gg(a,b,c){a=n[$a](180*n.atan2(b.y-a.y,b.x-a.x)/n.PI);c=n.min(45,45*c/2E3);if(a>=135+c||a<=-135-c)return Ri;if(a<=45-c&&a>=-45+c)return wj;if(a<-45-c&&a>-135+c)return $j;if(a>45+c&&a<135-c)return hi}function Ig(a){a=Qd[a];if(a!=h){for(var b=1<q.devicePixelRatio,c=j,e=h,d=0;d<a[L];d++){var f=a[d],k=K[f].t;if(k==be)e=f,c=g;else if(k==ce){if(c==j||b==g)e=f;if(b==g)break}else c==j&&(e=f)}return e}}function qk(a){var b=K[a].g;if(b!=h&&Ig(b)!=a)Jg(a);else{var b=
new Image,c=function(){Jg(a)},e=He(a);b.onload=c;b.onerror=c;b.onabort=c;b.src=e;b.vb=a}}function Jg(a){a=Jb[nb](a);-1!=a&&Jb[Da](a,1);0>=Jb[L]&&Kg()}function Kg(){sd!=h&&sd(j,C);if(Wa({type:kf},C)!==j)if(-1==me)Kc(Ha);else{rc=g;for(var a=-1,b=0;b<Aa[L];b++){for(var c=Aa[b].X,e=0;e<c[L];e++)if(c[e]==me){a=b;break}if(-1!=a)break}-1==a&&(a=0);Ha=a;Rd(me)}}function He(a){var b=K[a];if(b==h)return Y;var c=b.n;a=Y;b.r!=g&&(a+=le+kd);a+=c;b=Wa({type:mf,url:a});typeof b===Fj&&(a=b);return a}function Dd(a){for(var b=
0;b<t[L];b++)if(t[b].o==a)return b;return-1}function qc(a){a=t[a];return a==h?h:a.o}function pa(){return na(qc(F))}function Gd(a){return a.getElementsByClassName(Se)}function ub(a,b,c,e,d,f,k,l,m){a[y]({i:b,t:c,d:e,f:d,o:f,s:k,e:l,r:m,p:0})}function Lg(a,b,c,e,d){b={i:a,n:a,f:30,d:b,a:c,b:[]};C[Nb](ch,g);C[Nb](dh,g);t[F].T[a]=b;Ed(a,c,b);Cd=a;Qc=function(){xg(e,d,a)};db(a,h,j)}function Sd(a,b,c,e){var d=C[Q][ab],f=a[Ka]($e),k=b[Ka]($e);if(T[J[a.id]]){var l=Td(f),m=Ud(f);ba(a,Gh,l,ai,m)}a=Td(k);k=
Ud(k);ba(b,Gh,a,ai,k);c&&(c=l,a>c&&(c=a),ha(C[B],z(c)),Gb[C.id]=h,C[B].margin==eh&&ba(b,Of,n.max(0,(l<a?d<c?d-l:c-l:d<c?d-a:c-a)/2)));e&&(b=m,k>b&&(b=k),ma(C[B],z(b)))}function Ud(a){var b=C[Q].offsetHeight,c=t[a].b;return c!=h?c/100*b:t[a].Z}function Td(a){var b=C[Q][ab],c=t[a].a;return c!=h?c/100*b:t[a].Y}function Rd(a,b,c,e){if(!(qc(a)==h||Fd==g)){c==h&&(c=1.1);c=Be(c,60);Fd=g;var d=function(){e!=h&&e();Oa=[];Ld={};var d=pa();ic=t[a].a!=h||t[a].b!=h?g:j;var f=qc(a),k=F,m=pa();if(m!=h)for(var m=
m[Fa](dk),p=0;p<m[L];p++)m[p].pause&&m[p].pause();m=Va[Qa](0);for(p=0;p<m[L];p++)m[p].cb==ca&&nc(m[p]);var p=[],r;for(r in sb)if(sb[H](r)!=j){var m=j,s;for(s in qb)if(qb[H](s)!=j){for(var u=0;u<qb[s][L];u++)if(r==qb[s][u]){m=g;break}if(m==g)break}m==j&&p[y](r)}for(m=0;m<p[L];m++)delete sb[p[m]];Tc=[];F=Dd(f);r=na(f);s=r[Ka]($e);if(w.Ba!=h&&(m=pa(),m!=h)){m=m[Fa](dk);for(p=0;p<m[L];p++){u=m[p];oa(u,Y);var v=u.outerHTML,E=u[Q];E[Db](u);oa(E,E.innerHTML+v)}}if(Jc!=h){for(m=0;m<ud[L];m++)ud[m].destroy();
ud=[]}m=na(f);T[f]={};var f=[],p=t[k].v,D;for(D in p)if(p[H](D)!=j){var z=p[D];(k=z.cL)&&f[y](k)}var p=m[Ka]($e),u=t[p].v,v=[],E=[],I=0;for(D in u)if(u[H](D)!=j&&(z=u[D],k=z.cL)){for(var K=j,P=0;P<f[L];P++)if(f[P]===D){K=g;break}var R=S[k][Cb],P=R;P[Q][zb]==Xe&&(P=R[Q]);if(K){if(T[J[R.id]]){for(var z=R,$=K=0;z&&z.id!=aa;)K+=l(z,Of,0),$+=l(z,fh,0),z=z[Q];ba(R,Of,K,fh,$)}C[Za](P);S[k].mb?ra(P[B],P[B][Pb]+100):(E[y](P),P[B][Pb]>I&&(I=P[B][Pb]))}else v[y]([P,R,z]);S[k].bb==j&&(Ag(P,g),S[k].bb=g,P[Q]!=
h&&P[Q][Db](P))}for(P=0;P<E[L];P++)R=E[P],ra(R[B],R[B][Pb]-I-1);Ag(m,j);for(P=0;P<v[L];P++)m[Za](v[P][0]),R=v[P][1],z=v[P][2],De(z,R,R.id,g);D={type:of};Wa(D,m);k=t[p].dA;k!=h&&X(m,k.a)(D);D=t[s].T;for(var V in D)D[H](V)!=j&&(k=t[F].T[V],k.s==ca&&Ed(V,k.a,k));V={C:Ni,D:Pi,E:Oi};for(var W in V)V[H](W)==j||t[s][W]==h||(D=X(pa(),t[s][W].a),k=V[W],sc[k]=D,x[Ca]?x[Ca](k,D,j):x[jb]&&x[jb](hj+k,D));W=t[s].L;for(m=0;m<W[L];m++)V=W[m].B,D=X(pa(),W[m].a),Cg(V,D,h);W={G:Ri,H:wj,I:$j,J:hi};for(var Z in W)if(W[H](Z)!=
j&&(V=t[s][Z])){V=V.a;D=g;for(m=0;m<V[L];m++)if(0!=V[m].p){D=j;break}D==j&&(V=X(pa(),V),Ib(r,{wa:1,direction:W[Z],Ea:30,ca:Hj},V))}(Z=t[s].K)&&Eg(x,Z);Z=pa();if(2==b){Sd(d,Z,g,g);W=c;r=[];ra(Z[B],1);ub(r,ki,0,W,fh,J[Z.id],0,1);if(d!=h)if(ra(d[B],0),Zf==j)s=J[d.id],ub(r,ki,0,W,fh,s,1,0);else if(d[B][La]!=Z[B][La]||d[B][mb]!=Z[B][mb])s=J[d.id],ub(r,ki,W/2,W/2,fh,s,1,0);ba(Z,ki,0);Lg(cf,W,r,d,Z);la(Z[B],zh)}else 4==b||5==b||6==b||7==b?(W=c,r=[],D=d[Ka]($e),k=Z[Ka]($e),s=Td(D),V=Td(k),D=Ud(D),k=Ud(k),
5==b||4==b?(Sd(d,Z,j,g),s!=V&&(ub(r,Gh,0,W,Gh,aa,s,V),T[aa]={},T[aa].c=s,T[aa].d=D>k?D:k,T[aa].a=0,T[aa].b=0)):(Sd(d,Z,g,j),D!=k&&(ub(r,ai,0,W,Gh,aa,D,k),T[aa]={},T[aa].c=s>V?s:V,T[aa].d=D,T[aa].a=0,T[aa].b=0)),m=Of,f=V,p=-1*V,5==b?(f=-1*s,p=s):6==b?(m=fh,f=-1*D,p=D):7==b&&(m=fh,f=k,p=-1*k),d!=h&&(u=J[d.id],ba(d,Gh,s,ai,D),ub(r,m,0,W,Gh,u,0,f)),ub(r,m,0,W,Gh,J[Z.id],p,0),ba(Z,Gh,V,ai,k,m,p),Lg(df,W,r,d,Z),la(Z[B],zh)):(Sd(d,Z,j,j),xg(d,Z,h));Kb()},f=j,k=pa();k[Ya](dh);if(Mg==g&&k!=h){var k=Dd(qc(F)),
p={type:pf};if(Wa(p,h)!==j){var m=t[k].B;if(m!=h){for(var r=m.a,E=X(pa(),r),m=0;m<r[L];m++){var u=r[m],s=u.b;3==u.p&&(s!=h&&t[k].T[s]!=h)&&(f=g,Cd=s,Qc=d)}E(p)}}p=Gd(pa());for(m=0;m<p[L];m++)r=p[m],yg(r)!=j&&!t[k].v[J[r.id]].cL&&(E={type:sf},Wa(E,r),(u=l(r,Hh))&&X(r,u.a)(E));for(var v in sc)sc[H](v)!=j&&(x[Mb]?x[Mb](v,sc[v],j):x[za]&&x[za](hj+v,sc[v]));sc={};for(m=0;m<Pd[L];m++)v=Pd[m],Vc(v.eventType,v.handler,v[Cb]);Pd=[]}Mg=g;f==j&&d()}}function Kc(a,b,c){rc=j;var e=Aa[a];e==h||Fd==g||(e=Ng(e),
Rd(e,b,c,function(){Ha=a}))}function Ie(a){for(var b=[],c=0;c<a.X[L];c++){var e=a.X[c],d=t[e];b[y]({_:e,name:d.n,breakpoint:d.d,width:d.Y,height:d.Z})}return b}function Og(a,b){for(var c=Ie(b),e=0;e<c[L];e++)if(c[e].name==a)return c[e]._;return-1}function Je(){for(var a=[],b=0;b<Aa[L];b++)a[y](Aa[b].n);return a}function hb(a,b,c){a=a.id;a=J[a]||a;var e=T[a];e==h&&(e={},T[a]=e);e[b]=c}function l(a,b,c){c="undefined"!=typeof c?c:h;a=a.id;a=T[J[a]||a];if(a==h)return c;b=a[b];return b==h?c:b}function Wa(a,
b){var c=q.HYPE_eventListeners;if(c!=h){for(var e,d=0;d<c[L];d++)if(c[d][xa]==a[xa]&&c[d].callback!=h&&(e=c[d].callback(R.API,b,a),e===j))return j;return e}}function Pg(a){var b=x[Fa](xi)[0];b||(b=x[Ob](gi),x[Sa][Za](b));b[Za](a)}function Qg(a){a=a[yb](/\|/g,Hc)[yb](/\`/g,si)[yb](/\@/g,ck)[yb](/\?/g,Ji)[yb](/\$/g,Wi)[yb](/\^/g,jd);td==j&&(a=a[yb](/rotateY\(0\)/g,fj));var b=x[Ob](gi),c=x.xmlEncoding==h?zc:Y;oa(b,c+Zd+a+Wd+c);Pg(b)}function Wc(a,b){var c=b.f,e=n[Fb](a);return Be(e+100*(a-e)/c,c)}function rk(){for(var a in Ke)Ke[H](a)!=
...
c,d.perspective=c;d.pointerEvents=fj;d[nj]=fj;e[Za](a);return e}function gb(a){var b=F;a!=h&&(a=a[Ka]($e),a!=h&&(b=ea(a)));return b}function ig(a){var b=[],c=gb(x[lb](vb[a])),e=t[c].v,d;for(d in e)if(e[H](d)!=j){var f=e[d];(f.bF==a||f.bF==h&&a==t[c].o)&&b[y](d)}return b}function xd(a){var b=gb(x[lb](vb[a]));a=t[b].v[a];return a==h?h:a.bF}function te(a){if(ic!=j){Gb={};a=ig(a);for(var b=0;b<a[L];b++){var c=a[b],e=na(c);jc(e);te(c)}}}function Kb(){if(!(0<Jb[L])){if(rc==j&&Le==j){Le=g;var a=Ng(Aa[Ha]);
F!=a&&Rd(a,1,0);Le=j}ic==g&&te(h)}}function Ng(a){var b=Ie(a),c=b[0]._;if(1!=b[L]){var e=C.parentElement[ab];if(0!=e)for(var d=0;d<b[L]&&!(b[d].breakpoint>e);d++)c=b[d]._}b=t[c].n;e=Wa({type:lf,layoutName:b,sceneName:a.n},C);typeof e===Fj&&e!=b&&(a=Og(e,a),-1!=a&&(c=a));return c}function hg(a){var b=vb[qc(F)];a!=h&&(b=vb[a]);a=Gb[b];a==h&&(a=x[lb](b),a={width:a[ab],height:a.offsetHeight},Gb[b]=a);return a}function gg(a){var b=0,c=0;a==h?(b=x[lb](vb[a]),a=gb(b),b=t[a].Y,c=t[a].Z):(b=ue(a),c=ve(a));
return{width:b,height:c}}function re(a){return(w.ta!=h||3.5<=w.Fa||10<=w.ga)&&l(a,ef)==od}function ng(){yd=j;we=g;for(var a=0;a<Oc[L];a++)jc(Oc[a]);we=j;jg();Oc=[]}function jg(){Jc==h||Me==g||(Me=g,q[wb](function(){Me=j;Jc.refreshAll()},0))}function yg(a){var b=gb(a);return t[b].U[J[a.id]]!=h||l(a,Nh)!=h?g:j}function Ne(a,b,c){var e=b;if(e==h||x[lb](e)!=h){do e=c+Oe();while(x[lb](e)!=h)}vb[a]=e;J[e]=a;return Pe[b!=h?b:e]=e}function na(a){return x[lb](vb[a])}function Na(){return Date.now()}function Oe(){for(var a=
Y,b=R.Qa+Re,c=0;20>c;c++)var e=n[Fb](n.random()*b[L]),a=a+b.substring(e,e+1);return a}function Mc(a){q.console&&q.console.log(a)}var R=this,C=x[lb](aa),Hd=[Rh,Sh],Rc=[Pf,Sf,Rf,Tf,Qf,qh,Uf,Vf,uh,Qh],sg=[Qj,ik,Pj,wi,Zh,hk,Cj],wg={top:{HYP_r:fh},left:{HYP_r:Of},width:{HYP_r:Gh},height:{HYP_r:ai},"background-image":{HYP_x:g,HYP_r:Uh},rotateZ:{HYP_r:pi,HYP_s:0},scaleX:{HYP_r:Oh,HYP_s:1},scaleY:{HYP_r:Ph,HYP_s:1},"z-index":{HYP_r:gk},opacity:{HYP_r:ki,HYP_s:1}},Ha=0,F=0,Oa=[],Va=[],Ia={},Ja={},lc={},sb=
{},S={},Ad=j,Qd={},Jb=[],T={},Ce={},Tc=[],sc={},Qc=h,Cd=h,vb={},J={},Pe={},Sg=0,Fd=j,Pd=[],kc={},Mg=j,ic=j,yd=j,we=j,Oc=[],Gb={},Ld={},Ke={d:[[0,0,0.42,0,1,1,1,1]],e:[[0,0,0,0,0.58,1,1,1]],c:[[0,0,0.42,0,0.58,1,1,1]]},rc=j,Le=j,Jc=q.HYPE_w_648,ud=[],Me=j;R.Qa=nd;R.na=dd;var Uc=j,Md=0,Nd=j,Sc=[];R.z_o=function(){0==Sg&&(Sg=Oe());sd!=h&&sd(g,C);td=td&&w.ta!=h;w.Ba!=h&&x[Sa][Ca](Uj,jk(),w.Ta?{passive:j}:j);vb[aa]=aa;J[aa]=aa;Pe[aa]=aa;for(var a=0;a<t[L];a++){var b=t[a].T,c;for(c in b)if(b[H](c)!=j){var e=
...
b){Ib(a,{wa:1,direction:$j,Ea:30,ca:Hj},X(a,b.a))},cJ:function(a,b){Ib(a,{wa:1,direction:hi,Ea:30,ca:Hj},X(a,b.a))},cK:dc,cF:dc,aM:function(a,b){va(aj,a,oe(a,b),j);va($i,a,vd(a,b),j)},aN:function(a,b){Ic&&(va(Vj,a,oe(a,b),j),va(Uj,a,vd(a,b),j),va(Tj,a,vd(a,b),j),a[B][gd]=vj);va(Yi,a,oe(a,b),j);va(bj,a,vd(a,b),j)},V:pe,U:pe,W:pe,w:function(a,b){oa(a,b);for(var c=a[Fa](zj),e=0;e<c[L];e++){var d=c[e];if(d.src==h||d.src==Y)(q.execScript||function(a){q.eval.call(q,a)})(d.text||d.textContent)}},bT:function(a,
