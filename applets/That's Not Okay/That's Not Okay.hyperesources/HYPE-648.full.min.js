...
Ye=".HYPE_scene ",Ze=".Matrix(M11=",$e=".gradient(startColorstr=#00FFFFFF,endColorstr=#00FFFFFF)",af=".png",bf="/",Pf="0",Qf="0 0 ",Rf="0%",Sf="0.0",Tf="0123456789ABCDEF",Uf="0px",Vf="1",Wf="1.0",Xf="100",Yf="100%",Zf="50%",$f="600px",ag=": ",bg="</defs>",cg="</div>",dg="</linearGradient>",eg="</pattern>",fg="</style>",gg="</svg>",hg="<defs>",ig="<div style='overflow:auto;-webkit-overflow-scrolling:touch;width:100%;height:100%;'>",jg="<embed src='",kg="<iframe frameBorder='0'style='width:100%;height:100%;border:none' allowfullscreen='true'></iframe>",
...
(function(){v.HYPE_648F=function(O,J,La,fe,sj,tj,Sa,I,lc,bq,qd,cf,fa,uj,Bg,df,cq,dq,eq,ge){function ef(a){var b=yb(a);if(!(fa!=h||a==k||0<Eb||b==k||b.nb==h))if(b=b.Pa[P[a.id]],b!=k){var c=1==n(a,al,0),d=n(a,il,0.5),e=n(a,jl,0.1),f=n(a,Nl,0.01);a=n(a,kl,0.001);0>=a&&(a=1E-6);c==h&&(d=0,e=1,a=Infinity);b.restitution=d;b.friction=e;b.frictionAir=f;c!=h&&A.Body.setDensity(b,a)}}function mc(a,b){var c,d,e,f=yb(a);if(!(fa!=h||a==k||0<Eb||f==k||f.nb==h)){var g=f.oa.world,j=P[a.id],l=f.Pa[j],m=n(a,al,0);
if(!(0==m&&l==k)){Eb+=1;var r=l!=k&&0==m;(l==k&&0!=m)==h?(l=vj(a),l=wj(a,l,h),l==k&&(l=A.Body[Ia]({elementId:a.id})),l.plugin=n(a,Gm,{}),A.Composite.add(g,l),f.Pa[j]=l):r==h&&(A.Composite.remove(g,l),Y(a,Gm,l.plugin),delete f.Pa[j],l=k);f=n(a,il,0.5);g=n(a,jl,0.1);j=n(a,Nl,0.01);r=n(a,kl,0.001);0>=r&&(r=1E-6);1==m&&(f=0,g=1,r=Infinity);xj(a);var t=P[a.id];d=n(a,lp,0.5);c=n(a,mp,0.5);e=nb(t,h);t=ob(t,h);d*=e;c*=t;e=ff(a);d=rd(e,[d,c]);c=d[0];d=d[1];e=q.PI*((da(n(a,Qm,0))-da(n(a,pm,0)))/180);var t=
...
p,0.1,10,1,e,c,j),l=g.physicsBody,g=g.centerPoint):l=A.Bodies.fromVertices(g.x,g.y,f,{elementId:a.id},p,0.1,10,1);if(l==k)return v.HYPE_DEBUG_PHYSICS==h&&console.log(Om+a.id),k;l.render.path=b;b=ff(a);b=zj(b);b=rd(b,[g.x,g.y]);g=nb(d,h);d=ob(d,h);g=b[0]/g;d=b[1]/d;n(a,sm)==k&&Y(a,sm,n(a,lp,0.5));n(a,tm)==k&&Y(a,tm,n(a,mp,0.5));Y(a,qm,g);Y(a,rm,d);Dg(a,g,d);Y(a,pm,n(a,Qm,0));return l}function Aj(a,b,c){var d=n(a,gl,0);if(Lc!=h||0==d||36==d)return{x:b,y:c};var e=P[a.id],f=ie(e),g=gf(f),j=Fg(f),l=gf(e),
...
b[z](D(g,0));b[z](D(d-l,0));if(0<l||0<s){y=hf(l,s);for(B=270+y;360>B;B+=y)e=l*A.Common.cos(B*q.PI/180)+(d-l),f=s*A.Common.sin(B*q.PI/180)+s,b[z](D(e,f))}b[z](D(d,s));b[z](D(d,c-u));if(0<t||0<u){y=hf(t,u);for(B=0+y;90>B;B+=y)e=t*A.Common.cos(B*q.PI/180)+(d-t),f=u*A.Common.sin(B*q.PI/180)+(c-u),b[z](D(e,f))}b[z](D(d-t,c));b[z](D(j,c));if(0<j||0<r){y=hf(j,r);for(B=90+y;180>B;B+=y)e=j*A.Common.cos(B*q.PI/180)+j,f=r*A.Common.sin(B*q.PI/180)+(c-r),b[z](D(e,f))}b[z](D(0,c-r));b[z](D(0,m));if(0<g||0<m){y=
hf(g,m);for(B=180+y;270>B;B+=y)e=g*A.Common.cos(B*q.PI/180)+g,f=m*A.Common.sin(B*q.PI/180)+m,b[z](D(e,f))}}d=ff(a);a=[];for(j=0;j<b[X];j++)g=rd(d,[b[j].x,b[j].y]),c=q[Nb](g[0]),g=q[Nb](g[1]),(0==a[X]||a[a[X]-1].x!=c||a[a[X]-1].y!=g)&&a[z]({x:c,y:g});b=$;for(d=0;d<a[X];d++)1<a[X]&&d==a[X]-1&&a[d].x==a[0].x&&a[d].y==a[0].y||(b+=ti+a[d].x+Uc+a[d].y+Uc);return b}function Gg(a){var b=db[P[a.id]];return 2==n(a,al,0)&&b!=k&&(b.a!=k||b.b!=k)?h:p}function Hg(a,b,c,d){if(-1!=Ga(ud,b)&&0!=n(a,al,0)){var e=yb(a);
b=$+b+Al;for(var f=n(a,b,[]);4<=f[X];)f.shift();f[z]({value:c,time:d});Y(a,b,f);-1==Ga(e.ib,a.id)&&e.ib[z](a.id)}}function Ej(a,b){var c,d,e;A.Composite.allBodies(a.oa.world);A.Composite.allBodies(a.oa.world);var f=q[Ab](1E3/60),g=q[Dc](1E3*b),j=g-a.Wb;a.Wb=g;a.Va+=q.min(f,a.Va+q[Dc](j));for(g=0;a.Va>=f&&20>g;)A.Engine.update(a.oa,f),a.Va-=f,g+=1;jf=a.nb=h;v.HYPE_DEBUG_PHYSICS==h&&a.Xb.controller.world(a.Xb);f=A.Composite.allBodies(a.oa.world);for(g=0;g<f[X];g++)if(e=f[g],j=w[Ub](e.elementId),!(e.elementId==
k||e.isStatic==h||Gg(j)==h)){xj(j);var l=w[Ub](e.elementId);c=P[l.id];d=[1,0,0,1,0,0];var m;m=Fj(l);m=m==k||td(m)==h?k:m;m!=k&&(d=ff(m));d=zj(d);d=rd(d,[e[Vb].x,e[Vb].y]);m=n(l,lp,0.5);var r=n(l,mp,0.5),t=nb(c,h);c=ob(c,h);d=Aj(l,d[0]-m*t,d[1]-r*c);c=d.x;d=d.y;e=da(n(l,pm,0))+e.angle*(180/q.PI);W(j,Ri,c);W(j,Qk,d);W(j,Qm,e[gc](6));yj(j)}Ig();a.nb=p}function he(a){a=A.Composite.allBodies(a.oa.world);for(var b=0;b<a[X];b++){var c=a[b];c.elementId!=k&&A.Sleeping.set(c,p)}}function Gj(a,b){if(!(b.gamma==
k||b.beta==k)){var c=q.sin(b.gamma*q.PI/180),d=q.sin(b.beta*q.PI/180)*q.cos(b.gamma*q.PI/180);a.Qb=(-q.atan(c/d)+(0>d?q.PI:0))*(180/q.PI);a.Rb=q[Za](c*c+d*d);d=a[vc];kf(d)==h&&(c=lf(d)*a.Rb,d=mf(d)+a.Qb,a.oa.world.gravity.x=c*A.Common.cos(d*q.PI/180),a.oa.world.gravity.y=c*A.Common.sin(d*q.PI/180));he(a);sd()}}function nf(a){for(;a!=k;){a=Fj(a);if(a==k)break;if(td(a)==h)return a}return k}function Fj(a){var b=n(a,Uk);if(b==k){var c=Ta(a);a=I[c].v[P[a.id]];a!=k&&(b=a.bF)}return ma(b)}function yb(a){a=
nf(a);return Jg(a!=k?a.id:k)}function Cg(){Eb=q.max(0,Eb-1)}function Jg(a){a==k&&(a=J);for(var b=0;b<Da[X];b++){var c=Da[b];if(c[vc]==a)return c}return k}function Kg(a){return a==k||a[vc]==k?p:ha[P[a[vc]]]!=k}function Lg(a){if((a==J||a==k)==h)return p;a=P[a];var b=Ta(ma(a));return I[b].v[a].bX}function kf(a){if((a==J||a==k)==h)return I[V].cA;if(Lg(a)==h)return a=nf(w[Ub](a)),a==k?kf(k):kf(a.id);a=P[a];var b=Ta(ma(a));return I[b].v[a].cA}function mf(a){if((a==J||a==k)==h)return I[V].bZ-90;if(Lg(a)==
h)return a=nf(w[Ub](a)),a==k?mf(k):mf(a.id);a=P[a];var b=Ta(ma(a));return I[b].v[a].bZ-90}function lf(a){if((a==J||a==k)==h)return I[V].bY;if(Lg(a)==h)return a=nf(w[Ub](a)),a==k?lf(k):lf(a.id);a=P[a];var b=Ta(ma(a));return I[b].v[a].bY}function Mg(a){if(Jg(a)==k){var b={};Da[z](b);a==k&&(a=J);b.identifier=a;b.Pa={};b.zc={};b.ib=[];b.Wb=0;b.Va=0;var c=A.Engine[Ia]({vc:h});b.oa=c;if(v.HYPE_DEBUG_PHYSICS==h){var d={element:w[Ub](a),engine:c},d=A.Render[Ia](d);b.Xb=d}var d=lf(a),e=mf(a);a=kf(a);c.world.gravity.x=
...
(t=0));0!=r||0!=t||0!=u?(b[Z](cp,$+r+ce+t),b[Z](dp,$+u)):(b[Cb](cp),b[Cb](dp));E.aa!=k&&b[Z](am,b[jb](am))}function Hj(a){var b=n(a,zl),c=n(a,am);b==k||c==k||(a=a[cb](jp),0!=a[X]&&a[0][Z](Op,Qf+b+Uc+c))}function Fb(a){var b=a.id+Qi;if(w[Ub](b)==k&&n(a,bm)!=k){var c=a.id+Oi,d=a.id+Pi,e=12>E.aa?$:Xp,f;f=$+sg+hg;f+=mg+c+jd;f+=pg;f+=qg;f+=dg;f+=og+d+kd;f+=lg+e+jn;f+=eg;f+=bg;f+=ng+b+ld;f+=gg;ya(a,f);R.cN(a,fo);Hj(a)}return w[Ub](b)}function Ng(a){var b=a.b,b=b==k?a.s:b,c=a.e;if(b&&c){var d=ma(a.o),e=
...
a[hc][X];c++){var d=a[hc][c];b[z]({ta:{x:d[0],y:d[1]},La:{x:d[2],y:d[3]},Ha:{x:d[4],y:d[5]},Ia:{x:d[6],y:d[7]},length:0,ea:[]})}pf(b,p,2,20,h);a=[];for(c=0;c<b[X];c++)for(var d=b[c].ea,e=0;e<d[X];e++)a[z](d[e][Oa]);return a}function Jj(a){var b=a[hc];if(b&&0<b[X]){var b=qa(b[0],0),c=a[hc];c||(c=[],a.path=c);var d=[];if(0==c[X])Ua(d,0,b),Ua(d,2,b),Ua(d,4,b),Ua(d,6,b),c[z](d);else if(1==c[X])d=c[0],Ua(d,6,b);else{var e=c[X]-1;Ua(d,0,qa(c[e],6));Ua(d,2,Oj(a,e));Ua(d,4,b);Ua(d,6,b);c[z](d)}Ua(d,4,Pj(a))}a.closed=
...
a[b+1])}function Qj(a,b,c){var d=a.x+-1*c*q.cos(b);a=a.y+-1*c*q.sin(b);return D(d,a)}function of(a,b){return a.x==b.x&&a.y==b.y}function Ma(a){return D(a.x,a.y)}function D(a,b){return{x:a,y:b}}function Rj(a,b,c){le!=k&&(a={element:a,triggerOnce:p,elementOffset:0},a[c]=function(){b()},c=new le.hypeS(a),qf[z](c))}function ia(a,b){return function(c){for(var d=0;d<b[X];d++){var e=b[d],f=e.p;if(1==f)wd(Sj(e.e,e.f),e.g,e.d);else if(3==f)e.b!=k&&(f=e.z!=ba?e.z:p,Hb(e.b,a!=k?a.id:k,f));else if(7==f)e.b!=
...
e.t;f=$+r+Zd+arguments.join(ce)+$d;try{eval(f)}catch(t){me(Bh+r+ag+t)}}}}}function Sj(a,b){var c=-1;if(b==k||0==b)a:{for(c=0;c<Sa[X];c++)if(Sa[c].o==a)break a;c=-1}else 1==b&&qb+1<Sa[X]?c=qb+1:2==b?c=qb-1:3==b?c=0:4==b&&(c=Sa[X]-1);return c}function rf(a,b){return function(c){Sg(c,b,P[a.id])}}function Tg(a,b){return function(c){Vj(c,b,P[a.id])}}function sf(a){var b=n(a,Zi,Pf),c=n(a,$i,Pf),d=n(a,Xi,Pf),e=n(a,Yi,Pf),b=typeof b!=ho?b:L(b),c=typeof c!=ho?c:L(c),d=typeof d!=ho?d:L(d),e=typeof e!=ho?e:
L(e);a[G][tl]=$+b+Uc+c+Uc+e+Uc+d}function nc(){}function Wj(a){var b=n(a,hj,8),c=n(a,gj,0);E.Nb==k&&(1==1-c&&a[G].removeProperty!=k?a[G].removeProperty(ca.wa+ul):a[G][ca.wa+ul]=pl+L(b)+Vc+(1-c)+De)}function Ug(a){var b=n(a,Ji);if(b!=k){var c=$;b==Vf?c=Tj(n(a,Ki)):b==Pf&&(c=$+fe+bf+n(a,Ii));b=kg;E.Ma!=k&&(b=ig+b+cg);ya(a,b);b=a[cb](sn)[0];b.src=c;a=n(a,xm);a!=k&&R.dY(b,a)}}function Vg(a,b){if(!(12>E.aa)){var c=b==h?xh:$,d=n(a,c+$k,0),e=n(a,c+Vk,0),f=n(a,c+Wk,0),g=n(a,c+Xk,1),j=n(a,c+Yk,1),l=n(a,c+
...
h)}function tf(a){var b=n(a,Sk),c=n(a,Tk),d=n(a,Rk),e=n(a,jj);b==k||(c==k||d==k||e==k)||(a[G].textShadow=(0==b&&0==c&&0==e)==h?fo:$+L(b)+Uc+L(c)+Uc+L(e)+Uc+fb(d))}function ne(a){if(1==n(a,bn,0))Vg(a);else{var b=n(a,Di),c=n(a,Gi),d=n(a,Ci),e=n(a,Bi),f=n(a,bn,0);if(!(b==k||c==k||d==k||e==k))for(var g=[ca.wa+vl,xi,wl,vl],j=0==b&&0==c&&0==e,b=(2==f?yn:$)+L(b)+Uc+L(c)+Uc+L(e)+Uc+fb(d),c=0;c<g[X];c++)j==h?a[G][Cb]?a[G][Cb](g[c]):a[G].removeProperty(g[c]):a[G][g[c]]=b}}function oe(a){var b=n(a,Uh,$),c=n(a,
...
(N[T].cQ!=k||N[T].cR!=k||Lc==h&&0!=(N[T].bS&256))){s=h;break}Y(a,ci,s)}s=df==h&&-1==a[uc][Wb](Mh)&&1==m&&1==r&&s==p&&y==p&&C==p&&!(x==h&&50<=E.ub);if(10<=E.aa&&0==j&&(1!=m||1!=r)&&0==n(a,yi,0)&&0==n(a,zi,0)&&0==n(a,Ai,0)&&0==n(a,ui,0))j=1E-5;c!=k&&(b+=gd+L(c,2)+ae);d!=k&&(b+=hd+L(d,2)+ae);0!=e&&(b+=id+L(e)+ae);0!=l&&n(a,dl)==Li&&(b+=ad+($+l+zm)+ae);0!=j&&(b+=ad+($+j+zm)+ae);if(E.cb==h){if(0!=g||s==h)b+=cd+($+g+zm)+ae;0!=f&&(b+=bd+($+f+zm)+ae)}1!=m&&(b+=dd+m+ae);1!=r&&(b+=ed+r+ae);if(0!=t||0!=u)b+=
fd+($+t+zm)+ce+($+u+zm)+ae;c=$+($+100*B+pd)+Uc+($+100*S+pd);a[G][ca.wa+zp]=c;a[G].MozTransformOrigin=c;a[G].OTransformOrigin=c;a[G][Ne]=c;a[G][zp]=c;a[G][Ue]=b;a[G].MozTransform=b;a[G].OTransform=b;a[G][Me]=b;a[G].transform=b}function oc(a){9>E.aa?oe(a):Ad(a);fa==h&&Kc(a)}function Xg(a){function b(a,b){var j=b==h?(q.abs(e)+180)%360:(360-q.abs(e)+270)%360;return $+a+Hn+($+j+zm)+ce+fb(c)+ce+fb(d)+$d}if(Fb(a)!=k)vd(a);else{var c=n(a,Zn);if(!(c==k||c==$)){var d=n(a,Jn);if(!(d==k||d==$)){var e=n(a,Fn);
e!=k&&(E.xa!=k?na(a[G],b(ca.wa,p)):E.lc!=k?na(a[G],b(Ie,p)):10>E.aa?a[G][Pe]=b($,p):na(a[G],15>E[ac]?b(Oe,p):b($,h)))}}}}function Xj(a){var b=0==n(a,Fm,1)&&n(a,Si)==k&&n(a,Wi)==k&&n(a,Ti)==k&&n(a,bl)==k;if(n(a,gi,p)!=b){var c=n(a,rp);b==h?(a[Z](pj,h),R.ti(a,k)):(a[Cb](pj),R.ti(a,c));Y(a,gi,b)}}function Yj(a){var b=a[G][kb];ra(a[G],n(a,Rl,p)==h?fo:n(a,Eo,$));b==fo&&uf(P[a.id])}function Jb(a){Mc[a.id]=k;Nc(a)}function Nc(a){try{if(jf==h)-1==Ga(pe,a)&&pe[z](a);else{var b=n(a,gl,36),c=Wg(a),d=P[a.id],
e=ie(d),f=gf(e),g=Fg(e),j=gf(d),l=n(a,Ri,0),m=n(a,Qk,0),r=n(a,zl,k),t=n(a,am,k),u=e=h;r==k&&(e=p,r=j[F]);t==k&&(u=p,t=j[K]);var s=nb(d),x=ob(d),y=x-t,j=l,B=m,S=s,C=x,M=p;if(Lc==h&&36!=b){var N=0!=(b&1),T=0!=(b&4),I=0!=(b&2),J=0!=(b&8),A=0!=(b&32),D=0!=(b&16),U=0!=(b&64)&&I==h&&D==h,V=0!=(b&128)&&I==h&&D==h,M=0!=(b&256)&&(I==h||D==h),Q=0==f[F]?0:g[F]/f[F],O=0==f[K]?0:g[K]/f[K];I==h&&(S=N==h&&T==h?s+(g[F]-f[F]):q[Ab](s*Q));N==h&&T==h&&I==p?(b=l+s/2,j=q[Ab](b*Q-s/2)):N==h&&T==p&&I==h?j=g[F]-f[F]+l-(S-
...
L(B),Ca(a[G],L(j)));if(c==h||M==h)9>E.aa?oe(a):Ad(a);fa==h&&(y==h?Kc(a):mc(a));n(a,bm)!=k==h&&Hj(a);if(n(a,vm)==Ei){var la=Zj(d);0<la[X]&&Ad(ma(la[0]))}Yg==p&&$j()}}catch(qa){}}function Tj(a){a!=k&&0===a[Wb](Up)&&(a=kn+a);return a}function vf(a){return a[kc](/'/g,Md)}function Ga(a,b){if(a[Wb])return a[Wb](b);for(var c=0;c<a[X];c++)if(a[c]==b)return c;return-1}function ak(a){return typeof a==ap&&((7==a[X]||4==a[X])&&a[Gc](0)==md||0==a[Wb](Jo)&&a[Wb]($d)==a[X]-1)}function bk(a,b,c){var d=c.da,e=Kb(a,
...
ba){d=Zg[e];if(a.b!=k){if(c.qb[e]==k&&(d=a.o,m=a.a,m!=ba)){r=Zg[m];a={};t=[];for(f=x=B=0;f<r.va[X];f++){y=r.va[f];if(0==f)var B=nb(d),x=ob(d),S=aa[d].b,B=aa[d].a+B/2-y.ta.x,x=S+x/2-y.ta.y;t[z]({ta:{x:y.ta.x+B,y:y.ta.y+x},La:{x:y.La.x+B,y:y.La.y+x},Ha:{x:y.Ha.x,y:y.Ha.y},Ia:{x:y.Ia.x,y:y.Ia.y},length:0,ea:[]});x=B=0}a.va=t;wa(a,pf(a.va,h));c.qb[m]=a;m=ma(d);if(n(m,dl)==Li){for(var C,m=0;m<c.sa[X];m++)if(r=c.sa[m],r.i==cl){C=r;break}C!=k&&(a=ck(a,0,d),C.b=a.Qa)}}d=c.qb[e]}c=ck(d,s,j);g==Ri?(u=c.x,n(l,
...
p){f=p;break a}f=h}b=b&&f;e.bc=f==h?c:k}0===a||b==p?sd():a!=k&&v[ec](function(){xf=p;gk()},1E3*a)}function hk(a,b){var c=a.eb,d=[];if(c!=k)for(var e=0;e<c[X];e++){var f=c[e].b,g=la(f);g==k||-1!=Ga(d,f)||(Ed(g),b==h&&bh(g,h),Xb(0,f,p,h),d[z](f))}}function Xb(a,b,c,d){yf(b);var e=la(b);if(e!=k)return qe(e,1),-1==Ga(Lb,e)&&(Ib(b),Lb[z](e)),b=za(e),a>b&&(a=e.pa.q==h?q.max(0,a-q[Dc](a/b)*b):b),e.da==h&&(a=b-a),d==h&&(a=Aa(a,e)),e.Ca=0,e.Oa=0,e.ra=[],e.ya=[],d=zb()/1E3,e.ia=d-a,e.na=d-e.ia,e.fa==h&&(v[Ya](e.Da),
...
(l=f.s),W(m,j,l)),c[g][j]=h)}}}}function xd(a,b,c,d){yf(a);var e=la(a);e!=k&&(c&&qe(e,1),Dd(e,b),e.fa==p&&(e.ia!=k?e.na==za(e)?d&&Hb(a,k,b):(e.fa=h,e.ia=zb()/1E3-e.na/e.ja,v[Ya](e.Da),e.Da=v[ec](function(){Fd(e)},1E3*((za(e)-e.na)/e.ja)),e.Ja!=h&&(ch(e,e.na),e.Ca=0,e.Oa=0,e.ra=[],e.ya=[]),Oc(e.na/e.ja,e,p,p)):(d==h||0==e.na)&&Hb(a,k,b)),sd())}function Ib(a,b){for(var c in Cd)Cd[H](c)!=p&&Cd[c]==a&&Ib(c,k);yf(a);c=la(a);c!=k&&c.fa==h&&(qe(c,1),c.na=b!=k?b:zb()/1E3-c.ia,c.fa=p,v[Ya](c.Da),c.pa!=k&&
c.na==c.pa.d&&Fd(c))}function Fd(a){if(!(fa==h&&a.Ja==h)&&(a.ja=1,!Oc(za(a),a,h,h)))if(a.pa.q==h)Hb(a.ca,k,a.da);else if(Ed(a),re!=k&&zf==a.ca)a=re,zf=re=k,a();else if(a={type:ri,timelineName:a.pa.n},Mb(a,k)!==p){var b=Ha();if(b!=k){var c=I[Af(Qc(V))].F;c!=k&&ia(b,c.a)(a)}}}function Aa(a,b){return fa==h&&b.Ja==h?Bf(a,60):Bf(a,b.pa.f)}function Bf(a,b){var c=q[Dc](a);return c+q[Nb]((a-c)*b)/b}function za(a){return fa==h&&a.Ja==h?86400:Aa(a.pa.d,a)}function sd(){if(xf!==h){xf=h;var a=function(a){v[ec](a,
1E3/60)};(v.requestAnimationFrame||v.webkitRequestAnimationFrame||v.mozRequestAnimationFrame||a)(function(){xf=p;gk()})}}function Ed(a){v[Ya](a.Da);a.Ca=0;a.Oa=0;a.ra=[];a.ya=[];a.sc=k;a.ia=k;a.fa=p;a.ja=1;a.na=za(a);a=Ga(Lb,a);-1!=a&&Lb[ab](a,1)}function jk(a){for(var b=0;b<Lb[X];b++){var c=Lb[b];if(!(a!=k&&c.ca==a.ca))for(var d=0;d<c.ra[X];d++)rb[c.ra[d].o][c.ra[d].i]!=c.ca&&(c.ra[ab](d,1),d--)}}function ch(a,b){for(var c=a.sa,d=0;d<c[X];d++){var e=c[d],f=e.o,g=e.i,e=Aa(Kb(e,a)+e.d,a);rb[f]===ba&&
(rb[f]={});if(e>=b&&(db[f]===ba||db[f][g]===ba||db[f][g]==a.ca))rb[f][g]=a.ca}jk(a)}function Hb(a,b,c){yf(a);for(var d=0;d<sb[X];d++){var e=sb[d];e.ca==a&&Ed(e)}var f=la(a);if(f!=k)if(f.sc=b,Lb[z](f),I[V].T[f.ca]==k&&f.Ab==ba&&f.Ja!=h)Fd(f);else if(a=c==p,f.Ja!=h&&(bh(f,a),Dd(f,c),ch(f,0),ik(f,0)),f.fa=h,f.Ca=0,f.Oa=0,f.ra=[],f.ya=[],f.qb={},f.ia=zb()/1E3,v[Ya](f.Da),f.Da=v[ec](function(){Fd(f)},1E3*(za(f)/f.ja)),hk(f,a),f.Ja==h||0<f.sa[X]||0<f.eb[X])Oc(0,f,h,h,p),sd()}function yf(a){var b=la(a);
...
x.id,h);d={type:li};Mb(d,c);f=I[e].dA;f!=k&&ia(c,f.a)(d)}function fh(a,b,c,d){var e=[Uk,gl,vm,lp,mp,Qk,Ri,zl,am,zn,bn,bm],f=P[c];aa[f]==k&&(aa[f]={});var f=Ta(b),g=I[f].U[P[c]];if(g){var j=function(a){var b=g.V[a];if(b!=k)return b;if(-1!=Ga(kk,a[Ec]()))return g.W;me(Ah+a+Pd);return k};pc[P[c]]={symbolName:function(){return g.n},element:function(){return b},getSymbolInstancesByName:function(a){a=rk(a);for(var c=[],d=0;d<a[X];d++)for(var e=a[d],f=e[Ac]()[xc];f!=k;){if(f==b){c[z](e);break}f=f[xc]}return c},
...
e[c],W(b,f,a[f]);fa==h&&a.bM!=k&&W(b,Qm,0);ue[z](El,Fl,Gl,Hl,Il,Dl);for(var l in a)if(a[H](l)!=p){e=h;for(c=0;c<Df[X];c++)if(Df[c]==l){e=p;break}if(e!=p){if(d==h)for(c=0;c<ue[X];c++)if(ue[c]==l){e=p;break}e!=p&&W(b,l,a[l])}}E.aa!=k&&a.bE==k&&(b[G].behavior=Gp+Rc(Ee)+Qd)}function gq(){ve[ab](0,1)}function Ef(a){ve[z](Ff(a));v[ec](gq,2500)}function Gf(a){for(var b=0;b<ve[X];b++){var c=Ff(a);25>q.abs(c.x-ve[b].x)&&25>q.abs(c.y-ve[b].y)&&(a.stopPropagation(),a[bb]())}}function rk(a){var b=[],c=I[V].U,
d;for(d in c)c[H](d)!=p&&c[d].n==a&&b[z](pc[d]);return b}function Uj(a){var b={type:si,customBehaviorName:a},c=Hf[a];if(c!=k)for(var d=0;d<c[X];d++)c[d](b);for(var e in ha)ha[H](e)!=p&&(c=ha[e].Pb[a],c!=k&&c(b));Mb(b,k)}function sk(a,b,c){c?ha[c].Pb[a]=b:(c=Hf[a],c==k&&(c=[],Hf[a]=c),c[z](b))}function hh(a,b,c,d){function e(a){a=a?a:v[Pb];(32==a.keyCode||13==a.keyCode)&&f(a)}function f(a){a=a?a:v[Pb];if(a[Na]==Rn){for(var e=p,f=0;f<we[X];f++)if(we[f]==c){e=h;break}if(e==h)return;we[z](c)}else if(a[Na]==
Qn){e=Ta(b);if(I[e].v[P[b.id]]==k)return;a||(a=v[Pb]);for(e=w.elementFromPoint(a[Qb],a[Rb]);e!=k&&e!=this&&e.nodeName!=yh;)e=e[cc];if(e==this)return;we=[]}else if(-1!=Ga([On,Sn,yo],a[Na])){if(a[Tb]==h||0!=a[vb])return}else a[Na]==yp?0<a[fc][X]&&Ef(a[fc][0]):a[Na]==wp&&0<a[dc][X]&&Ef(a[dc][0]);if(d==h&&(a[Na]==Nn||a[Na]==Sn||a[Na]==wp)){if(0<If)return;Jf=h}c(a)}if(a==Wl||a==Sn)a=ja.pointerEnabled||v.PointerEvent?yo:ja.msPointerEnabled?vi:Sn;Va(a,f,b,h);a==Wl?Va(Dn,e,b,h):a==On?Va(Cn,e,b,h):a==Sn&&
...
b)return k;c=ih(Sa[b]);var f=Qc(c);qk(f,V);var m=ma(f);c=0==g?sc(c):tc(c);Gd(e,m,p,p);W(m,l,d?-1*c:j);d=v[ec](function(){ra(m[G],ql);uf(f)},0);return{o:f,size:c,sE:m,cI:b,Sb:d}}function d(a,b,c){return{i:zg,t:a,d:0,s:{a:c?c:[{p:Qg,hc:function(){wd(b,Kf,0)}}]},p:wf}}var e=Ha(),f=P[e.id],g=a.c,j=0==g?sc(V):tc(V),l=0==g?Ri:Qk,m=c(ro,so,h),r=c($n,bo,p),t=fi+l,n=[],s=0;r!=k&&(gb(n,l,0,2,am,f,-1*j,0),gb(n,l,0,2,am,r.o,0,j),n[z](d(0,r.cI)),s+=2);var x=s;n[z](d(x,k,[{p:7,b:t},{p:Qg,hc:b}]));m!=k&&(gb(n,l,
s,2,Fm,f,0,j),f=-1*m.size,gb(n,l,s,2,Fm,m.o,f,f+j),s+=2,n[z](d(s,m.cI)));se(t,n,{i:t,n:t,f:30,d:s,a:n,b:[],fc:b}).na=x;return{b:t,c:g,A:0==g?0:1,y:h,K:1.5*(j/2),p:a.p}}function uk(a,b){for(var c={Ta:1,gc:h,ka:Dm},d=b.a,e=h,f=0;f<d[X];f++){var g=d[f],j=g.p;0!=j&&(e=p);10==j&&g.b!=k?(c.ga==k&&(c.ga=[]),c.ga[z]({b:g.b,c:g.c,A:g.A,y:g.y,K:100/g.K})):11==j?c.za=a:16==j&&(c.Ya==k&&(c.Ya=[]),c.Ya[z](g))}e==p&&Sc(a,c,ia(a,d))}function tk(a){return function(b){a.fb=p;a.gb=p;for(var c=b.target||b.srcElement,
d=Ha();c!=k&&c!=d;){if(c[G]&&(c[G].overflow==So||c[G].overflow==Nk)){a.fb=0<c.scrollWidth-c[$b];a.gb=0<c.scrollHeight-c[wb];break}c=c[cc]}c=a.fb==p&&a.gb==p;a.ma=b[Na]==yp;if(a.ma)0<b[fc][X]&&(a[wc].ka==op&&c==h)&&Ef(b[fc][0]),a.Xa=b[fc][X];else{if(b[Tb]==h||0!=b[vb])return;b[bb]&&c==h&&b[bb]()}if(a.ma==p||1===a.Xa){a.Ka=Xo;a.Aa=k;c=[];for(d=0;5>=d;d++)c[z]({start:{x:0,y:0},end:{x:0,y:0},lastPosition:{x:0,y:0}});a.Sa=c;a.Ua=ba;a.wb=p;var c=a.ma?b[fc][0]:b,e;e=function(b){jh(a);a.Ka=Tl;Lf(b,a)};a.qa=
e;b=a.ma?a.Ra:w;a.ma?Va(vp,a.qa,b,p):v.self!=v.top&&(d=function(a){(a.relatedTarget===w.documentElement||a.toElement===k)&&e(a)},a.qa=d,Va(Qn,d,b,p));c=Ff(c);d=a.Sa[0];d[yc].x=c.x;d.end.x=c.x;d[Fa].x=c.x;d[yc].y=c.y;d.end.y=c.y;d[Fa].y=c.y;vk(a,c);a.Kb=function(b){if(!(a.Ka===Km||a.Ka===Tl))if(Jf==h)a.qa(b);else{var c=a[wc];if(a.lb==p==h){If++;a.lb=h;if(c.Ya!=k){var d=h;if(c.ga==k)c.ga=[];else for(var e=0;e<c.ga[X];e++){var m=c.ga[e],r=m.b,t=la(r);16==m.p&&(t.fa!=h?(c.ga[ab](e,1),e--):(d=p,a.pb=h))}if(d)for(e=
0;e<c.Ya[X];e++)if(d=c.Ya[e],(0!=d.c||a.fb==p)&&(1!=d.c||a.gb==p))d=hq(d),c.ga[z](d)}if(c.ka==Dm){xe==h&&a.qa(b);a.Ra!=w&&(xe=h);if(c.ga!=k)for(e=0;e<c.ga[X];e++){r=c.ga[e].b;t=la(r);Ib(r,k);Dd(t,p);a.Ib=Pc(t.ca,p);for(var d=t.sa,u=0;u<d[X];u++){var s=d[u].o,x=d[u].i;db[s]===ba&&(db[s]={});db[s][x]=t.ca}}c.za!=k&&(e=P[c.za.id],a.Tb=n(c.za,Ph,aa[e].a),a.Ub=n(c.za,Oh,aa[e].b),rb[e]!=ba&&(rb[e].a=k,rb[e].b=k,jk(k)),db[e]===ba&&(db[e]={}),db[e].a=Hm,db[e].b=Hm,fa==h&&mc(c.za));Lf(b,a)}}var d=Ff(a.ma?
b[fc][0]:b),y=a.Sa[0];y[Fa].x=y.end.x;y[Fa].y=y.end.y;a.yb=a.Yb;y.end.x=a.ma?b[fc][0].pageX:d.x;y.end.y=a.ma?b[fc][0].pageY:d.y;u=zb();a.Yb=u;u-=a.kb;a.Aa=wk(y[yc],y.end,u);a.ma&&(a.Xa=b[fc][X]);a.Ka=Tn;if(c.ka==Dm){s=a.fb==p&&a.gb==p;if(c.ga!=k)for(e=0;e<c.ga[X];e++)if(m=c.ga[e],0==m.c&&a.fb==h||1==m.c&&a.gb==h){a.qa(b);return}b[bb]&&s==h&&b[bb]();9>E.aa&&(a.Ra.ondragstart=function(a){return a==k?p:h});var s=x=0,B=1,S=1;if(a.Ra!=k)for(var C=ie(P[a.Ra.id]);C!=k&&C!=J;)e=ma(C),x+=n(e,Ri,0),s+=n(e,
Qk,0),B*=n(e,Ll,1),B*=n(e,di,1),S*=n(e,Ml,1),S*=n(e,ei,1),C=ie(C);if(c.ga!=k){for(var M=c.ga,M=[],N=5<=pb(y.end,y[yc]),e=0;e<c.ga[X];e++){m=c.ga[e];if(16==m.p&&a.pb==p)if(N==p)continue;else if(r=m.b,!(0==m.c&&(a.Aa==Gn||a.Aa==No))&&!(1==m.c&&(a.Aa==Ep||a.Aa==Cm))){t=la(r);t=t.pa.fc;t!=k&&t();c.ga[ab](e,1);e--;continue}else a.Ib=Pc(r,p);M[z](m)}a.pb=a.pb||N;for(e=0;e<M[X];e++)if(m=M[e],r=m.b,t=la(r)){var t=za(t),N=xk(m),T;N==No?T=(y.end.x-y[yc].x)/B:N==Gn?T=(y[yc].x-y.end.x)/B:N==Ep?T=(y[yc].y-y.end.y)/
S:N==Cm&&(T=(y.end.y-y[yc].y)/S);m=T/m.K;m+=a.Ib;m=q.min(t,m);m=q.max(0,m);Xb(m,r,p,h)}else a.qa(b)}c.za!=k&&(e=P[c.za.id],T=a.Tb+(y.end.x-y[yc].x)/B,y=a.Ub+(y.end.y-y[yc].y)/S,Lc==p?(C=Fg(C),S=nb(e),T=q.max(T,-S/2-x),T=q.min(T,C[F]-S/2-x),e=ob(e),y=q.max(y,-e/2-s),y=q.min(y,C[K]-e/2-s)):(C=Aj(c.za,T,y),T=C.x,y=C.y),c=c.za,W(c,Ri,T,Qk,y),fa==h&&(Hg(c,Ri,T,u/1E3),Hg(c,Qk,y,u/1E3),Y(c,Cl,h),c=yb(c),he(c)));Lf(b,a)}else c.ka==kp?1<a.Xa?a.qa(b):(b[bb]&&a.Aa==c[Cc]&&b[bb](),T=c[Cc]==No||c[Cc]==Gn?y.end.x:
y.end.y,C=p,C=c[Cc]==No||c[Cc]==Cm?20<a.Ua-T:20<T-a.Ua,c=a.Aa===c[Cc]||100>u,(C||c==p||xe==h)&&a.qa(b)):c.ka==op&&5<pb(y[yc],y.end)&&a.qa(b);vk(a,d)}};Va(a.ma?xp:Pn,a.Kb,b,p);a.Jb=function(b){if(!(a.Ka===Km||a.Ka===Tl)&&!(b[fc]&&0<b[fc][X]))if(Jf==h&&0<If)a.qa(b);else{var c=a[wc];b[Na]==wp&&0<b[dc][X]&&c[Na]==op&&Ef(b[dc][0]);var d=zb(),e=d-a.kb,m=a.Sa[0];a.Aa=wk(m[yc],m.end,e);a.Ka=Km;db={};var r=1===a.Xa||!a.ma,n=0!==m.end.x;if(c.ka==Dm){if(a.lb==p){jh(a);return}if(c.ga!=k){r=(d-a.yb)/1E3;for(n=
0;n<c.ga[X];n++){var u=c.ga[n],d=u.b,e=la(d),s=u.y;if(e){var x=za(e),y=xk(u),B=u.K,S=p,C=p,M=1;if(s==h)if(s=0,s=0==u.c?q.abs(m[Fa].x-m.end.x)/r:q.abs(m[Fa].y-m.end.y)/r,s*=2,20<s)S=h,C=u,M=yk(m[Fa],m.end),C=(0==C.c?90<=M||-90>=M?Gn:No:0>=M&&-180<=M?Ep:Cm)!=y,M=s/B;else{B=y=Pc(e.ca,p);for(u=s=0;u<e.sa[X];u++){var N=e.sa[u];if(N.p==wf){for(var E=N.s.a,I=p,J=0;J<E[X];J++){var A=E[J];if(7==A.p&&A.b!=k&&A.b==d){I=h;break}}I==h&&(N=N.t,E=q.abs(N-y),E<B&&(B=E,s=N))}}x-y<B&&(s=x,B=x-y);0!=B&&(S=h,C=s<y,M=
q.abs(s-y)/0.2)}Dd(e,C);qe(e,M);S==h&&e.na!=x?xd(d,C,p,p):Xb(C?x-e.na:e.na,d,h,h)}}}Lf(b,a)}else c.ka==kp?(d=a.Aa===c[Cc],r=r&&n&&d,m=pb(m[yc],m.end),r&&m>c.hb?(b={type:ni+c[Cc][Gc](0).toUpperCase()+c[Cc][mb](1)+yg},a.Lb(b)):a.qa(b)):c.ka==op?1500>e&&a.Lb(b):a.qa(b);jh(a)}};Va(a.ma?wp:Sn,a.Jb,b,p);b.setCapture&&b.setCapture();a.kb=zb();a.yb=a.kb;a.lb=p;xe=Jf=a.pb=p}}}function jh(a){if(a.wb!=h){a.wb=h;db={};var b=a.ma?a.Ra:w;b.releaseCapture&&b.releaseCapture();ye(a.ma?xp:Pn,a.Kb,b);ye(a.ma?wp:Sn,
a.Jb,b);a.ma?ye(vp,a.qa,b):ye(Qn,a.qa,b);a[wc].ka==Dm&&(xe=p);a.lb==h&&If--;fa==h&&a[wc]&&mc(a[wc].za)}}function Lf(a,b){b[wc].gc==h&&(a.hypeGesturePhase=b.Ka,a.hypeGestureXPosition=b.Sa[0].end.x,a.hypeGestureYPosition=b.Sa[0].end.y,b.Lb(a))}function ye(a,b,c){var d=Fb(c);d!=k&&(c=d);c[Hc]?c[Hc](a,b,p):c[Pa]&&c[Pa](ko+a,b)}function Va(a,b,c,d){var e=Fb(c);e!=k&&(c=e);e={eventType:a,handler:b,element:c};d&&Mf[z](e);c[$a]?c[$a](a,b,E.Gb?{passive:p}:p):c[Sb]&&c[Sb](ko+a,b);Xj(c)}function Ff(a){var b=
...
45-c&&a>=-45+c)return No;if(a<-45-c&&a>-135+c)return Ep;if(a>45+c&&a<135-c)return Cm}function yk(a,b){var c=q[Bb](b.y-a.y,b.x-a.x);return q[Nb](180*c/q.PI)}function Rg(a){for(var b=Hd[a],c={},d=0;d<b[X];d++){var e=La[b[d]].t;E.Nb!=k&&e==Mk||(c[e]=Rc(b[d]))}b=-1!=fe[Wb](Vp)&&E.Ma!=k&&537<=E.xa;b=eq==h&&("undefined"!==typeof AudioContext||"undefined"!==typeof webkitAudioContext)&&-1==v[Oa].href[Wb](Tm)&&-1==fe[Wb](rn)&&b==p&&ja.onLine!=p&&E[ac]==k?zk:9>E.aa?iq:Ak;d={};d.Fb=E.Ma!=k&&603>E.xa;var f=Nf[a];
if(f==k){try{f=new b(a,c)}catch(g){b==zk&&(f=new Ak(a))}f.yc=a;f.bb=c;f.options=d;f.Eb=function(){var a=[],b;for(b in f.bb)f.bb[H](b)!=p&&a[z](b);return a.sort()}}return f}function fq(a,b){var c=Rg(a);ta(c,b);c[tb]()}function Bk(a){a=Hd[a];if(a!=k){for(var b=1<v.devicePixelRatio,c=p,d=k,e=0;e<a[X];e++){var f=a[e],g=La[f].t;if(g==vg)d=f,c=h;else if(g==wg){if(c==p||b==h)d=f;if(b==h)break}else c==p&&(d=f)}return d}}function kh(a,b){var c=Ga(Zb,a);-1!=c&&Zb[ab](c,1);0>=Zb[X]?Ck():b==h&&lh==p&&(lh=h,v[ec](function(){Dk()},
1))}function Dk(){0>=Zb[X]||(lh=p,Ek(Zb[0],h))}function Ek(a,b){var c=La[a].p;if(1==c)if(c=La[a].g,c!=k&&Bk(c)!=a)kh(a,b);else{var c=new Image,d=function(){kh(a,b)},e=Rc(a);c.onload=d;c.onerror=d;c.onabort=d;c.src=e;c.Ac=a}else 2==c&&(c=function(){for(var c=Hd[La[a].g],d=0;d<c[X];d++){var e=c[d];La[e].p!=k&&kh(e,b)}},d=Rg(La[a].g),E.Ma!=k&&536.26>E.xa||9>E.aa?v[ec](c,1):d.load(c,c))}function Ck(){cf!=k&&cf(p,U);if(Mb({type:hi},U)!==p)if(-1==Bg)wd(qb);else{Id=h;for(var a=-1,b=0;b<Sa[X];b++){for(var c=
Sa[b].X,d=0;d<c[X];d++)if(c[d]==Bg){a=b;break}if(-1!=a)break}-1==a&&(a=0);qb=a;Of(Bg)}}function Rc(a){var b=La[a];if(b==k)return $;var c=b.n;a=$;b.r!=h&&(a+=fe+bf);a+=c;b=Mb({type:ji,url:a});typeof b===ap&&(a=b);return a}function Af(a){for(var b=0;b<I[X];b++)if(I[b].o==a)return b;return-1}function Qc(a){a=I[a];return a==k?k:a.o}function Ha(){return ma(Qc(V))}function te(a){if(a.getElementsByClassName)return a.getElementsByClassName(Fh);var b=/(^|\s)HYPE_element(\s|$)/;a=a||w;a=a.all?a.all:a[cb](be);
for(var c=[],d,e=a[X],f=0;f<e;f++)d=a[f],b.test(d[uc])&&c[z](d);return c}function gb(a,b,c,d,e,f,g,j,l){a[z]({i:b,t:c,d:d,f:e,o:f,s:g,e:j,r:l,p:0})}function mh(a,b,c,d,e){b={i:a,n:a,f:30,d:b,a:c,b:[]};U[Z](oj,h);U[Z](pj,h);I[V].T[a]=b;se(a,c,b);zf=a;re=function(){eh(d,e,a,h)};Hb(a,k,p)}function Gd(a,b,c,d){var e=U[cc][Ob],f=a[jb](Nh),g=b[jb](Nh);if(aa[P[a.id]]){var j=sc(f),l=tc(f);W(a,zl,j,am,l)}a=sc(g);g=tc(g);W(b,zl,a,am,g);c&&(c=j,a>c&&(c=a),pa(U[G],L(c)),Mc[U.id]=k,U[G].margin==Nk&&W(b,Ri,q.max(0,
(j<a?e<c?e-j:c-j:e<c?e-a:c-a)/2)));d&&(b=l,g>b&&(b=g),ua(U[G],L(b)))}function tc(a){var b=U[cc].offsetHeight,c=I[a].b;return c!=k?c/100*b:I[a].Z}function sc(a){var b=U[cc][Ob],c=I[a].a;return c!=k?c/100*b:I[a].Y}function Of(a,b,c,d){if(!(Qc(a)==k||Cf==h)){c==k&&(c=1.1);c=Bf(c,60);Cf=h;var e=function(){d!=k&&d();sb=[];Hf={};var e=Ha();Lc=I[a].a!=k||I[a].b!=k?h:p;var f=Qc(a),g=V,j=Ha();if(j!=k){for(var l=j[cb](Kp),m=0;m<l[X];m++)l[m][jc]&&l[m][jc]();j=j[cb](Im);for(m=0;m<j[X];m++)0==j[m].id[Wb](Jm)&&
ya(j[m][xc],$)}m=Lb[mb](0);for(j=0;j<m[X];j++)m[j].Ab==ba&&Ed(m[j]);var j=[],r;for(r in pc)if(pc[H](r)!=p){var m=p,n;for(n in lc)if(lc[H](n)!=p){for(l=0;l<lc[n][X];l++)if(r==lc[n][l]){m=h;break}if(m==h)break}m==p&&j[z](r)}for(m=0;m<j[X];m++)delete pc[j[m]];we=[];if(fa==h){r=[];for(n=0;n<Da[X];n++)m=Da[n],Kg(m)==p&&r[z](m);for(n=0;n<r[X];n++)m=Jg(r[n][vc]),m!=k&&(m=Ga(Da,m),-1!=m&&Da[ab](m,1))}V=Af(f);r=ma(f);n=r[jb](Nh);fa==h&&Mg(k);if(E.Ma!=k&&(m=Ha(),m!=k)){m=m[cb](Kp);for(j=0;j<m[X];j++){l=m[j];
ya(l,$);var t=l.outerHTML,s=l[cc];s[Bc](l);ya(s,s.innerHTML+t)}}if(le!=k){for(m=0;m<qf[X];m++)qf[m].destroy();qf=[]}qk(f,g);var f=I[n].T,u;for(u in f)f[H](u)!=p&&(g=I[V].T[u],g.s==ba&&se(u,g.a,g));u={C:Cn,D:En,E:Dn};for(var A in u)u[H](A)==p||I[n][A]==k||(f=ia(Ha(),I[n][A].a),g=u[A],Jd[g]=f,w[$a]?w[$a](g,f,p):w[Sb]&&w[Sb](ko+g,f));A=I[n].L;for(m=0;m<A[X];m++)u=A[m].B,f=ia(Ha(),A[m].a),sk(u,f,k);A={G:Gn,H:No,I:Ep,J:Cm};for(var D in A)if(A[H](D)!=p&&(u=I[n][D])){u=u.a;f=h;for(m=0;m<u[X];m++)if(0!=u[m].p){f=
p;break}f==p&&(u=ia(Ha(),u),Sc(r,{Ta:1,direction:A[D],hb:30,ka:kp},u))}(D=I[n].K)&&uk(w,D);D=Ha();if(2==b){Gd(e,D,h,h);var L=c,Q=[];Ea(D[G],1);gb(Q,Fm,0,L,Qk,P[D.id],0,1);if(e!=k)if(Ea(e[G],0),uj==p){var O=P[e.id];gb(Q,Fm,0,L,Qk,O,1,0)}else if(e[G][F]!=D[G][F]||e[G][K]!=D[G][K])O=P[e.id],gb(Q,Fm,L/2,L/2,Qk,O,1,0);W(D,Fm,0);mh(Xh,L,Q,e,D);ra(D[G],ql)}else if(3==b&&E.cb==h){Gd(e,D,h,h);A=c;u=gb;f=W;g=U[G];g[Se]=$f;oa(g,$f);g.perspective=$f;g[ca.wa+Ap]=zo;g.MozTransformStyle=zo;g[Ap]=zo;r=U[Ob];g=r/
4;r/=2;n=-1*g;m=-1*r;j=A/2;t=D[jb](Nh);l=sc(t);t=tc(t);s=[];e!=k&&(L=P[e.id],Y(e,$h,Vf),O=e[jb](Nh),Q=sc(O),O=tc(O),f(e,Yp,1,el,0,zl,Q,am,O),u(s,Ri,0,j,am,L,0,r),u(s,el,0,j,am,L,0,-300),u(s,ij,0,j,am,L,0,-20),u(s,Yp,0,j,Ri,L,1,0));var R=P[D.id];Y(D,$h,Vf);u(s,Ri,0,j,am,R,n,m);u(s,el,0,j,am,R,-600,-300);u(s,ij,0,j,am,R,50,40);u(s,Yp,0,j,Ri,R,0,1);e!=k&&(u(s,Ri,j,j,Fm,L,r,g),u(s,el,j,j,Fm,L,-300,-600),u(s,ij,j,j,Fm,L,-20,-50),(Q!=l||O!=t)&&u(s,Fm,j,j,am,L,1,0));u(s,Ri,j,j,Fm,R,m,0);u(s,el,j,j,Fm,R,
-300,0);u(s,ij,j,j,Fm,R,40,0);f(D,Ri,g,el,-600,ij,50,Yp,0,zl,l,am,t);mh(Zh,A,s,e,D);ra(D[G],ql)}else 4==b||5==b||6==b||7==b?(L=c,Q=[],u=e[jb](Nh),f=D[jb](Nh),O=sc(u),A=sc(f),u=tc(u),f=tc(f),5==b||4==b?(Gd(e,D,p,h),O!=A&&(gb(Q,zl,0,L,zl,J,O,A),aa[J]={},aa[J].c=O,aa[J].d=u>f?u:f,aa[J].a=0,aa[J].b=0)):(Gd(e,D,h,p),u!=f&&(gb(Q,am,0,L,zl,J,u,f),aa[J]={},aa[J].c=O>A?O:A,aa[J].d=u,aa[J].a=0,aa[J].b=0)),g=Ri,r=A,n=-1*A,5==b?(r=-1*O,n=O):6==b?(g=Qk,r=-1*u,n=u):7==b&&(g=Qk,r=f,n=-1*f),e!=k&&(m=P[e.id],W(e,
zl,O,am,u),gb(Q,g,0,L,zl,m,0,r)),gb(Q,g,0,L,zl,P[D.id],n,0),W(D,zl,A,am,f,g,n),mh(Yh,L,Q,e,D),ra(D[G],ql)):(Gd(e,D,p,p),eh(e,D,k,h));rc()},f=p,g=Ha();g[Cb](pj);if(Fk==h&&g!=k){var g=Af(Qc(V)),j={type:mi};if(Mb(j,k)!==p){var l=I[g].B;if(l!=k){for(var m=l.a,r=ia(Ha(),m),l=0;l<m[X];l++){var t=m[l],u=t.b;3==t.p&&(u!=k&&I[g].T[u]!=k)&&(f=h,zf=u,re=e)}r(j)}}j=te(Ha());for(l=0;l<j[X];l++)m=j[l],td(m)!=p&&!I[g].v[P[m.id]].cL&&(r={type:pi},Mb(r,m),(t=n(m,Dl))&&ia(m,t.a)(r));for(var s in Jd)Jd[H](s)!=p&&(w[Hc]?
w[Hc](s,Jd[s],p):w[Pa]&&w[Pa](ko+s,Jd[s]));Jd={};for(l=0;l<Mf[X];l++)s=Mf[l],ye(s.eventType,s.handler,s[Ac]);Mf=[]}Fk=h;f==p&&e()}}function wd(a,b,c){Id=p;var d=Sa[a];d==k||Cf==h||(d=ih(d),Of(d,b,c,function(){qb=a}))}function nh(a){for(var b=[],c=0;c<a.X[X];c++){var d=a.X[c],e=I[d];b[z]({_:d,name:e.n,breakpoint:e.d,width:e.Y,height:e.Z})}return b}function Gk(a,b){for(var c=nh(b),d=0;d<c[X];d++)if(c[d].name==a)return c[d]._;return-1}function oh(){for(var a=[],b=0;b<Sa[X];b++)a[z](Sa[b].n);return a}
function Y(a,b,c){a=a.id;a=P[a]||a;var d=aa[a];d==k&&(d={},aa[a]=d);d[b]=c}function n(a,b,c){c="undefined"!=typeof c?c:k;a=a.id;a=aa[P[a]||a];if(a==k)return c;b=a[b];return b==k?c:b}function Mb(a,b){var c=v.HYPE_eventListeners;if(c!=k){for(var d,e=0;e<c[X];e++)if(c[e][Na]==a[Na]&&c[e].callback!=k&&(d=c[e].callback(ca.API,b,a),d===p))return p;return d}}function Hk(a){var b=w[cb](en)[0];b||(b=w[Ic](Bm),w[xb][Db](b));b[Db](a)}function Ik(a){a=a[kc](/\|/g,He)[kc](/\`/g,Ym)[kc](/\@/g,Jp)[kc](/\?/g,xn)[kc](/\$/g,
Ln)[kc](/\^/g,Ye);df==p&&(a=a[kc](/rotateY\(0\)/g,fo));var b=w[Ic](Bm),c=w.xmlEncoding==k?Od:$;ya(b,c+rg+a+fg+c);Hk(b)}function ze(a,b){var c=b.f,d=q[Dc](a);return Bf(d+100*(a-d)/c,c)}function jq(){for(var a in ph)ph[H](a)!=p&&(qd[a]={q:ph[a]});for(var b in qd)if(qd[H](b)!=p)if(a=qd[b].q,typeof a===ap)Bd[b]=eval(a);else{for(var c=[],d=0;d<a[X];d++){var e=a[d];c[z]({ta:{x:e[0],y:e[1]},La:{x:e[2],y:e[3]},Ha:{x:e[4],y:e[5]},Ia:{x:e[6],y:e[7]},length:0,ea:[]})}pf(c,p);Bd[b]=c}}function pf(a,b,c,d,e){var f=
0;d==k&&(d=100);c==k&&(c=100);for(var g=0;g<a[X];g++){var j=a[g],l=0,m=d;e==h&&j.ta.x==j.La.x&&j.ta.y==j.La.y&&j.Ia.x==j.Ha.x&&j.Ia.y==j.Ha.y?m=2:(m=pb(j.ta,j.Ia),m=q[Ab](q.max(q.min(m/2,d),c)));for(var r=j.ta,n=0;n<m;n++){var u=fk(j,n/(m-1)),s={};s.location=u;b&&(r=pb(u,r),l+=r,wa(s,r));j.ea[z](s);r=u}f+=l;wa(j,l)}return f}function fk(a,b){var c=Kd(a.ta,a.La,b),d=Kd(a.La,a.Ha,b),e=Kd(a.Ha,a.Ia,b),f=Kd(c,d,b),d=Kd(d,e,b),f=Kd(f,d,b),g=p,j=d;d.x==f.x&&d.y==f.y&&(c.x==f.x&&c.y==f.y?j=e:(j=c,g=h));f.Qa=
...
V;a!=k&&(a=a[jb](Nh),a!=k&&(b=ea(a)));return b}function Zj(a){var b=[],c=Ta(w[Ub](Yb[a])),d=I[c].v,e;for(e in d)if(d[H](e)!=p){var f=d[e];(f.bF==a||f.bF==k&&a==I[c].o)&&b[z](e)}return b}function ie(a){var b=Ta(w[Ub](Yb[a]));a=I[b].v[a];return a==k?k:a.bF}function uf(a){if(Lc!=p){Mc={};a=Zj(a);for(var b=0;b<a[X];b++){var c=a[b],d=ma(c);Nc(d);uf(c)}}}function rc(){if(!(0<Zb[X])){if(Id==p&&qh==p){qh=h;var a=ih(Sa[qb]);V!=a&&Of(a,Kf,0);qh=p}Lc==h&&(uf(k),fa==h&&he(yb(k)))}}function ih(a){var b=nh(a),
c=b[0]._;if(1!=b[X]){var d=U[xc][Ob];if(0!=d)for(var e=0;e<b[X]&&!(b[e].breakpoint>d);e++)c=b[e]._}b=I[c].n;d=Mb({type:ii,layoutName:b,sceneName:a.n},U);typeof d===ap&&d!=b&&(a=Gk(d,a),-1!=a&&(c=a));return c}function Fg(a){var b=Yb[Qc(V)];a!=k&&(b=Yb[a]);a=Mc[b];a==k&&(a=w[Ub](b),a={width:a[Ob],height:a.offsetHeight},Mc[b]=a);return a}function gf(a){var b=0,c=0;a==k?(b=w[Ub](Yb[a]),a=Ta(b),b=I[a].Y,c=I[a].Z):(b=nb(a),c=ob(a));return{width:b,height:c}}function Wg(a){return(E.xa!=k||3.5<=E.Wa||10<=
E.aa)&&n(a,$h)==Vf}function Ig(){jf=p;Yg=h;for(var a=0;a<pe[X];a++)Nc(pe[a]);Yg=p;$j();pe=[]}function $j(){le==k||rh==h||(rh=h,v[ec](function(){rh=p;le.refreshAll()},0))}function td(a){var b=Ta(a);return I[b].U[P[a.id]]!=k||n(a,Jl)!=k?h:p}function sh(a,b,c){var d=b;if(d==k||w[Ub](d)!=k){do d=c+th();while(w[Ub](d)!=k)}Yb[a]=d;P[d]=a;return uh[b!=k?b:d]=d}function ma(a){return w[Ub](Yb[a])}function zb(){return(new Date).getTime()}function th(){for(var a=$,b=ca.xb+Eh,c=0;20>c;c++)var d=q[Dc](q.random()*
b[X]),a=a+b.substring(d,d+1);return a}function me(a){v.console&&v.console.log(a)}function Ak(a){var b=this;Nf[a]=b;b.ab=function(){var a=w[Ic](rj);b.ua=a;for(var d=b.Eb(),e=0;e<d[X];e++){var f=d[e],g=w[Ic](Vo);g[Z](Wo,b.bb[f]);g[Z](Cp,f);a[Db](g)}w[xb][Db](a);return a};b.load=function(a,d){if(!(b.Ba==h||b.Na==h)){var e=b.ab(d),f=function(){v[Ya](b.cc);b.Ba!=h&&(b.Na=p,b.Ba=h,a!=k&&a(b),b.Za==h&&b[tb]())},g=function(){v[Ya](b.cc);b.Ba!=h&&(b.Na=p,d!=k&&d(b))};e[$a](Ul,f,h);e[$a](kj,g,h);e[$a](Mm,g,
h);b.cc=v[ec](g,15E3);b.Na=h;ja.onLine==k||ja.onLine==h?e.load():f()}};sa(b,function(){if(b.Ba!=h){if(b.Na==h){b.Za=h;return}b.Ba=h}b.ua==k&&b.ab(k);try{ta(b.ua,b.loop),b.ua.currentTime=0}catch(a){}var d=b.ua[tb]();if(d!==ba)d[Vl](aq())});xa(b,function(){b.Ba!=h?b.Za=p:b.ua!=k&&b.ua[jc]()})}function zk(a){var b=this;Nf[a]=b;b.load=function(a,d){if(!(b.Ba==h||b.Na==h)){b.Na=h;var e=b.tc();-1==e[Wb](ug)&&(e=$+e+ug);var f=new XMLHttpRequest;f.open(Dh,e,h);f.responseType=qj;f.onload=function(){b.Na=p;
b.Ba=h;b.Cb=f.response;a!=k&&a(b);b.Za==h&&b[tb]()};f.onerror=function(){b.Na=p;d!=k&&d(b)};try{f.send()}catch(g){}}};sa(b,function(){b.Mb();var a=v.HYPE_gac_648;a==k&&(a=new (v.AudioContext||v.webkitAudioContext),v.HYPE_gac_648=a);a.resume!=k&&a.resume();b.source=a.createBufferSource();b[zc].connect(a.destination);ta(b[zc],b.loop);b[wc].Fb==h&&b.tb();b.Ba!=h?(b.Za=h,b.load()):b.Cb!=k?(a.decodeAudioData(b.Cb,function(a){b.ec=a;b[zc].buffer=a;b[wc].Fb!=h&&b.tb()}),b.Cb=k):(b[zc].buffer=b.ec,b[wc].Fb!=
...
rb={},db={},Cd={},pc={},ha={},xf=p,Hd={},Zb=[],lh=p,aa={},dh={},we=[],Jd={},re=k,zf=k,Yb={},P={},uh={},Kk=0,Cf=p,Mf=[],Zg={},Bd={},Fk=p,Lc=p,jf=p,Yg=p,pe=[],Mc={},Hf={},ph={d:[[0,0,0.42,0,1,1,1,1]],e:[[0,0,0,0,0.58,1,1,1]],c:[[0,0,0.42,0,0.58,1,1,1]]},Id=p,qh=p,le=v.HYPE_w_648,qf=[],rh=p;ca.xb=Tf;ca.wa=Qe;ca.ob=Bo;var xe=p,If=0,Jf=p,ve=[];ca.z_o=function(){0==Kk&&(Kk=th());cf!=k&&cf(h,U);df=df&&E.xa!=k;E.Ma!=k&&w[xb][$a](xp,aq(),E.Gb?{passive:p}:p);Yb[J]=J;P[J]=J;uh[J]=J;for(var a=0;a<I[X];a++){var b=
I[a].T,c;for(c in b)if(b[H](c)!=p){var d=b[c];d.d=ze(d.z,d);for(var e=0;e<d.a[X];e++){var f=d.a[e];f.t=ze(f.y,d);f.d=ze(f.z,d);f.p==k?f.p=0:f.p==wf&&(f.d=0);f.r==k&&(f.r=p);f.k=e}e=d.b;for(f=0;f<e[X];f++){var g=e[f];g.startTime=ze(g.C,d);g.duration=ze(g.D,d)}}}Ik(Xe);cq==h&&Ik(Mi);for(a=0;a<sj[X];a++)b=sj[a],c=w[Ic](Bm),ya(c,b),Hk(c),9>E.aa&&(b=b.match(/('|")(http.*?css.*?)('|")/),b!=k&&2<=b[X]&&w.createStyleSheet(b[2]));v[ec](rc,120);v[ec](rc,1200);a=w[Ic](Bm);a.id=Lh;ra(a[G],fo);a[Z](pj,h);U[Db](a);
for(b=0;b<I[X];b++){c=I[b];d=w[Ic](Bm);e=d[G];Ba(d,Mh);d.id=sh(c.o,k,nn);d[Z](Nh,c._);uj!=p&&(e.backgroundColor=fb(c.c));ra(e,fo);d[Z](pj,h);e.overflow=gn;va(e,lj);pa(e,L(c.Y));ua(e,L(c.Z));E.cb==h&&11>E.aa&&(e.perspective=c.p);U[Db](d);var e=c.v,j;for(j in e)if(e[H](j)!=p&&(f=e[j],(g=f.cL)&&ha[g]==k)){var l=c.T,m=[],n;for(n in l)if(l[H](n)!=p){var t=c.T[n],u=t.a;t.s==g&&(t=se(n,u,t,g),m[z](t))}l=w[Ic](f.k);Ba(l,f.cP?Jh+f.cP:Hh);l.id=sh(j,f.i,mn);l[Z](Nh,c._);l[G].pointerEvents=Nk;l[G][xo]=Nk;f.w!=
...
g?ha[g][Ac][Db](l):d[Db](l)}}for(j=0;j<I[X];j++){n=I[j].T;for(var x in n)if(n[H](x)!=p){s=n[x].j;for(var y in s)if(s[H](y)!=p){a=s[y];b={};c=[];for(d=0;d<a[X];d++)e=a[d],c[z]({ta:{x:e[0],y:e[1]},La:{x:e[2],y:e[3]},Ha:{x:e[4],y:e[5]},Ia:{x:e[6],y:e[7]},length:0,ea:[]});b.va=c;wa(b,pf(c,h));Zg[y]=b}}}jq();if(fa==h){var B,A;"undefined"!==typeof w.hidden?(B=gn,A=Pp):"undefined"!==typeof w.wc?(B=Un,A=Vn):"undefined"!==typeof w.xc?(B=Wn,A=Xn):"undefined"!==typeof w.Bc&&(B=Rp,A=Sp);"undefined"===typeof w[$a]||
"undefined"===typeof w[B]||w[$a](A,function(){if(w[B])for(var a=0;a<Da[X];a++){var b=Da[a];b.ca!=k&&Ib(b.ca)}else for(a=0;a<Da[X];a++)b=Da[a],b.ca!=k&&xd(b.ca)},p)}for(var C in La)La[H](C)!=p&&(x=La[C].g,x!=k&&(y=Hd[x],y==k&&(y=[],Hd[x]=y),y[z](C)));for(var D in La)La[H](D)!=p&&La[D].p!=k&&-1==Ga(Zb,D)&&Zb[z](D);C=Zb[mb](0);if(0==C[X])Ck();else if(9>E.aa)Dk();else for(D=0;D<C[X];D++)Ek(C[D],p);v[$a]?(v[$a](Io,function(){Id=p;rc()}),v[$a](no,function(){v[ec](rc,1)})):v[Sb]&&v[Sb](lo,function(){Id=
p;rc()});ge&&(U[G][Te]=Mo,U[$a]&&(U[$a](Wl,Gf,h),U[$a](Sn,Gf,h),U[$a](On,Gf,h),U[$a](Rn,Gf,h)))};var E;var Xa=function(a){return(a=ja&&ja[Ka]&&ja[Ka].match(a))&&a[1]},Q={};if(ja){Q.aa=da(Xa(/MSIE (\d+\.\d+)/))||da(Xa(/(Trident)/)&&Xa(/rv:(\d+\.\d+)/))||da(Xa(/Edge\/(\d+\.\d+)/))||k;Q.lc=da(Xa(/Gecko\/(\d+)/))||k;Q.Wa=da(Xa(/Firefox\/(\d+\.\d+)/))||k;Q.xa=da(!Q.aa&&Xa(/AppleWebKit\/(\d+\.\d+)/))||k;Q.ub=da(Q.xa&&Xa(/Chrome\/(\d+\.\d+)/))||k;Q.$b=da(Q.xa&&Xa(/Safari\/(\d+\.\d+)/)&&Xa(/Version\/(\d+\.\d+)/))||
k;Q.opera=da(Xa(/Opera\/(\d+\.\d+)/)&&Xa(/Version\/(\d+\.\d+)/))||Xa(/Opera\/(\d+\.\d+)/)||da(Q.xa&&Xa(/OPR\/(\d+\.\d+)/))||k;Q.Nb=-1<ja[Ka][hb](wh)||k;Q.nc=-1<ja[Ka][hb](on)||k;Q.oc=-1<ja[Ka][hb](pn)||k;Q.pc=-1<ja[Ka][hb](qn)||k;Q.Ma=Q.nc||Q.oc||Q.pc||k;Q.Zb=w.compatMode==zh||k;Q.cb=Q.xa!=k||10<=Q.Wa||10<=Q.aa;for(var vh in Q)(Q[vh]===k||isNaN(Q[vh]))&&delete Q[vh];Q[ac]&&Q.aa&&delete Q.aa;Q.Gb=p;try{var Lk=Object.defineProperty({},oo,{get:function(){Q.Gb=h}});v[$a](qp,k,Lk);v[Hc](qp,k,Lk)}catch(kq){}}E=
Q;var R={i:nc,cP:nc,b:Nc,a:Nc,c:Jb,d:Jb,bQ:function(a){Wg(a)==h&&Ad(a)},bS:Nc,t:function(a,b){a[G].fontSize=L(b)},s:function(a,b){a[G].fontFamily=b},v:function(a,b){a[G].fontWeight=b},u:function(a,b){a[G].fontStyle=b},H:function(a,b){a[G].textDecoration=b},F:function(a,b){a[G].textAlign=b},G:function(a,b){a[G].color=fb(b)},X:function(a,b){a[G].letterSpacing=L(b)},E:function(a,b){a[G].wordSpacing=L(b)},Y:function(a,b){a[G].lineHeight=L(b)},aX:Wj,aW:Wj,f:oc,bR:Ad,aY:Ad,cQ:oc,cR:oc,gW:oc,uB:oc,tX:oc,
tY:oc,bO:oc,bP:nc,e:function(a,b){if(9>E.aa||E.aa!=k&&E.Zb){if(1==ea(b))Y(a,Uh,$),Y(a,Th,$);else{var c=Ag+q[Nb](100*b)+$d;Y(a,Uh,ca.ob+Ve+c);Y(a,Th,c[Ec]());a[G].backgroundColor==$&&a[G].backgroundImage==$&&w[Ub](wn+a.id)==k&&na(a[G],Gp+vf(Rc(Ge))+Qd)}oe(a)}a[G].opacity=b;a[G].MozOpacity=b;Xj(a)},aP:function(a,b){a[G].cursor=b},bD:function(a,b){a[G][ca.wa+Hp]=b;a[G].MozUserSelect=b;a.onselectstart=function(){return p}},N:function(a,b){a[G].borderLeftWidth=L(b);Jb(a)},O:function(a,b){a[G].borderRightWidth=
...
hb:30,ka:kp},ia(a,b.a))},cI:function(a,b){Sc(a,{Ta:1,direction:Ep,hb:30,ka:kp},ia(a,b.a))},cJ:function(a,b){Sc(a,{Ta:1,direction:Cm,hb:30,ka:kp},ia(a,b.a))},cK:nc,cF:nc,aM:function(a,b){Wa(Rn,a,Tg(a,b),p);Wa(Qn,a,rf(a,b),p)},aN:function(a,b){ge&&(Wa(yp,a,Tg(a,b),p),Wa(xp,a,rf(a,b),p),Wa(wp,a,rf(a,b),p),a[G][Te]=Mo);Wa(On,a,Tg(a,b),p);Wa(Sn,a,rf(a,b),p)},V:Ug,U:Ug,W:Ug,w:function(a,b){var c=w[Ub](wn+a.id),c=c!=k?c.cloneNode(h):k;ya(a,b);for(var d=a[cb](Ro),e=0;e<d[X];e++){var f=d[e];if(f.src==k||f.src==
...
d!=k&&d[uc]==Kh&&(c=d);var d=ma(b),e=c[cc];d==k||(d==c||d==a||d==e)||(e[Bc](c),d[Db](c))},ti:function(a,b){b==k?a[Cb](np):a[Z](np,b)},cN:function(a,b){Fb(a)!=k&&(b=fo,eb(a));a[G].pointerEvents=b;a[G][xo]=b;if(11>E.aa){var c=function(b){b=b?b:v[Pb];if(a[G][xo]==fo){var c=a[G][kb];ra(a[G],fo);var f=w.elementFromPoint(b[Qb],b[Rb]);ra(a[G],c?c:$);w.createEvent?(b[bb](),c=w.createEvent(wi),c.initMouseEvent(b[Na],b.bubbles,b.cancelable,b.view,b.detail,b.screenX,b.screenY,b[Qb],b[Rb],b[Tb],b.altKey,b.shiftKey,
b.metaKey,b[vb],k),f.dispatchEvent(c)):(c=w.createEventObject(),c.clientX=b[Qb],c.clientY=b[Rb],f.fireEvent(ko+b[Na],c),event.cancelBubble=h)}};Va(vi,c,a,h);Va(Sn,c,a,h);Va(On,c,a,h);Va(Wl,c,a,h)}}},Nf={},Kj=function b(c){var d=this;d.copy=function(){var c=new b;c.ba=d.ba[mb](0);c.Ea=Ma(d.Ea);c.Fa=Ma(d.Fa);return c};d.vb=function(){for(var c=new b,f=0;f<d.ba[X];f++)c.ba[z](Og(d.ba[f]));c.Ea=Ma(d.Ea);c.Fa=Ma(d.Fa);return c};d.ic=function(b){var c=b[hc];if(!c||0==c[X])return[];var d=[],j;a:{if((j=b[hc])&&
1==j[X])if(j=j[0],of(qa(j,0),qa(j,6))==h){j=h;break a}j=p}if(j==h)j=c[0],b=qa(j,0),d[z](Gb(b,b,b));else for(var l=c[X],m=0;m<l-(b[Qa]==h?1:0);m++)j=c[m],0==m&&d[z](Gb(qa(j,0),qa(j,2),Pj(b))),m+1==l&&b[Qa]==p?d[z](Gb(qa(j,6),Oj(b,m),qa(j,4))):d[z](Gb(qa(j,6),qa(c[m+1],2),qa(j,4)));return d};d.Ob=function(b){for(var c=d.ba[mb](0),g=-1,j=-1,l=0,m=0,n=0;n<c[X];n++){var t=c[n];if(t.mb==h)l++;else{if(0<l){if(-1!=j){if(j=Nj(c[j],t,l),t=c,l=n-l-1,!(l>=t[X]))for(var u=0;u<j[X];u++)t[l+u]=j[u]}else m=l;l=0}-1==
